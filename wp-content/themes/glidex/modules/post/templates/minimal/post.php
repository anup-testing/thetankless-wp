<?php
    ...
    <?php glidex_template_part( 'post', 'templates/'.$Post_Style.'/parts/image', '', $template_args ); ?>
    ...
    <div class="post-meta">
    	...
    	<div class="meta-right">
			<?php glidex_template_part( 'post', 'templates/'.$Post_Style.'/parts/comment', '', $template_args ); ?>
    	</div><!-- Meta Right -->
