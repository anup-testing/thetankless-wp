...
if( !class_exists( 'Glidex_Woo_Listing_Option_Thumb_Element_Group' ) ) {

    class Glidex_Woo_Listing_Option_Thumb_Element_Group extends Glidex_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'glidex_woo_custom_product_template_thumb_options', array( $this, 'woo_custom_product_template_thumb_options'), 55, 1 );
        }
...
if( !function_exists('glidex_woo_listing_option_thumb_element_group') ) {
	function glidex_woo_listing_option_thumb_element_group() {
		return Glidex_Woo_Listing_Option_Thumb_Element_Group::instance();
	}
}

glidex_woo_listing_option_thumb_element_group();