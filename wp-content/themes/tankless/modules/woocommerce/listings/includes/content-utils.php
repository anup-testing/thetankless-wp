...
function glidex_shop_products_addtional_features($product_ids = '') 
{
	...
	if (isset($custom_settings['product-features']) && is_array($custom_settings['product-features'])) {
		$product_features = $custom_settings['product-features'];
		
		echo '<div class="product-features-list">';
		foreach ($product_features as $feature) {
			$title = isset($feature['pdt-feature-title']) ? esc_html($feature['pdt-feature-title']) : '';
			$image_id = isset($feature['pdt-feature-image']) ? intval($feature['pdt-feature-image']) : '';
			$value = isset($feature['pdt-feature-value']) ? esc_html($feature['pdt-feature-value']) : '';
