...
class CSFramework_Option_background extends CSFramework_Options {
  ...
  public function output() {
    ...
    $button_title = ( isset( $button_title ) ) ? $button_title : esc_html__( 'Upload', 'glidex-pro' );
    $frame_title  = ( isset( $frame_title  ) ) ? $frame_title  : esc_attr__( 'Upload', 'glidex-pro' );
    $insert_title = ( isset( $insert_title ) ) ? $insert_title : esc_attr__( 'Use Image', 'glidex-pro' );

    echo '<div class="cs-field-upload">';
    echo '<input type="text" name="'. esc_attr($this->element_name( '[image]' )) .'" value="'. esc_attr($this->value['image']) .'"'. glidex_html_output($this->element_class()) . $this->element_attributes() .'/>';
