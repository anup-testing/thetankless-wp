...
class CSFramework_Option_color_picker extends CSFramework_Options {
  ...
  public function output() {
    ...
    echo '<input type="text" name="'. esc_attr($this->element_name()) .'" value="'. esc_attr($this->element_value()) .'"'. glidex_html_output($this->element_class( 'cs-field-color-picker' )) . $this->element_attributes( $this->extra_attributes() ) .'/>';
