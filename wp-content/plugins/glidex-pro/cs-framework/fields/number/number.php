...
class CSFramework_Option_number extends CSFramework_Options {
  ...
  public function output() {
    ...
    echo '<input type="number" name="'. esc_attr($this->element_name()) .'" value="'. esc_attr($this->element_value()).'"'. glidex_html_output($this->element_class()) . $this->element_attributes() .'/>'. $unit;
