...
if ( ! function_exists( 'cs_add_element' ) ) {
  function cs_add_element( $field = array(), $value = '', $unique = '' ) {
    ...
    $output .= '<div class="cs-element cs-element-'. $el_class .' cs-field-'. $field['type'] . $is_pseudo . $wrap_class . $hidden .'"'. glidex_html_output($depend) .'>';
    ...
    if( class_exists( $class ) ) {
      ...
      $output .= '<p>'. esc_html__( 'This field class is not available!', 'glidex-pro' ) .'</p>';
    }
