...
if (! class_exists ( 'GlidexProMegaMenuPostType' ) ) {

	class GlidexProMegaMenuPostType {
		...
		function __construct() {
            ...
            add_action ( 'admin_print_styles', array( $this, 'glidex_admin_print_styles') );
        	...
        	add_action( 'wp_update_nav_menu_item', array( $this, 'glidex_update_menu_item'), 10, 2 );
   			...
   			add_filter( 'wp_nav_menu_objects', array( $this, 'glidex_nav_menu_objects' ),10, 2 );
		...
		function glidex_register_cpt() {
			...
			$labels = array (
				'name'				 => __( 'Mega Menus', 'glidex-pro' ),
				'singular_name'		 => __( 'Mega Menu', 'glidex-pro' ),
				'menu_name'			 => __( 'Mega Menus', 'glidex-pro' ),
				'add_new'			 => __( 'Add Mega Menu', 'glidex-pro' ),
				'add_new_item'		 => __( 'Add New Mega Menu', 'glidex-pro' ),
				'edit'				 => __( 'Edit Mega Menu', 'glidex-pro' ),
				'edit_item'			 => __( 'Edit Mega Menu', 'glidex-pro' ),
				'new_item'			 => __( 'New Mega Menu', 'glidex-pro' ),
				'view'				 => __( 'View Mega Menu', 'glidex-pro' ),
				'view_item' 		 => __( 'View Mega Menu', 'glidex-pro' ),
				'search_items' 		 => __( 'Search Mega Menus', 'glidex-pro' ),
				'not_found' 		 => __( 'No Mega Menus found', 'glidex-pro' ),
				'not_found_in_trash' => __( 'No Mega Menus found in Trash', 'glidex-pro' ),
			);
		...
		function glidex_template_include($template) {
			if ( is_singular( 'wdt_mega_menus' ) ) {
				if ( ! file_exists ( get_stylesheet_directory () . '/single-wdt_mega_menus.php' ) ) {
					$template = GLIDEX_PRO_DIR_PATH . 'post-types/templates/single-wdt_mega_menus.php';
				}
			}
        ...
        function glidex_admin_print_styles() {
        ...
        function custom_fields( $item_id, $item, $depth, $args ) {
        	...
        	<p class="field-wdt-mega-menu-width description description-thin">
        		<label for="edit-menu-item-wdt-mega-menu-width-<?php echo esc_attr( $item_id ); ?>">
        			<?php esc_html_e( 'Mega Menu Width (px)','glidex-pro' ); ?><br />
                    ...
                    <span class="description"><?php esc_html_e('Please set Mega Menu Width',  'glidex-pro'); ?></span>
        		</label>
        	</p>
        	...
        	<p class="field-wdt-mega-menu-position description description-wide">
        		<label for="edit-menu-item-wdt-mega-menu-position-<?php echo esc_attr( $item_id ); ?>">
        			<?php esc_html_e( 'Mega Menu Position','glidex-pro' ); ?><br />
        			<select id="edit-menu-wdt-mega-menu-position-<?php echo esc_attr( $item_id ); ?>" class="widefat code edit-menu-item-wdt-mega-menu-position" name="menu-item-wdt-mega-menu-position[<?php echo esc_attr( $item_id ); ?>]">
                        <option value="none" <?php selected( $position, '' );?>><?php esc_html_e('None','glidex-pro');?></option>
                        <option value="left" <?php selected( $position, 'left' );?>><?php esc_html_e('Left','glidex-pro');?></option>
                        <option value="right" <?php selected( $position, 'right' );?>><?php esc_html_e('Right','glidex-pro');?></option>
                        <option value="center" <?php selected( $position, 'center' );?>><?php esc_html_e('Top - Center','glidex-pro');?></option>
        			</select>
                    <span class="description"><?php esc_html_e('Please set Mega Menu Position',  'glidex-pro'); ?></span>
        		</label>
        	</p><?php
        }
        ...
        function glidex_nav_menu_objects( $items, $args ) {
            ...
            foreach ( $items as $item ) {
                if( is_a( $args->walker, 'Glidex_Walker_Nav_Menu' ) || is_a( $args->walker, 'Glidex_Default_Header_Walker_Nav_Menu' ) ) {
        ...
        function add_classes( $classes, $item, $args, $depth  ) {
        	...
        	if ($item->object == 'wdt_mega_menus' && $depth == 1) {
                ...
                if( is_a( $args->walker, 'Glidex_Walker_Nav_Menu' ) || $args->theme_location == 'main-menu' || is_a( $args->walker, 'Glidex_Default_Header_Walker_Nav_Menu' ) ) {
...
GlidexProMegaMenuPostType::instance();