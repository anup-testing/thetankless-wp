...
class Elementor_Post_Categories extends GlidexElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Categories', 'glidex-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-categories-wrapper '.$style.' '.$el_class.'">';
            $out .= glidex_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/category', '', $template_args );
		$out .= '</div>';
