...
class Elementor_Post_Date extends GlidexElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Date', 'glidex-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-date-wrapper '.$style.' '.$el_class.'">';
            $out .= glidex_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/date', '', $template_args );
		$out .= '</div>';
