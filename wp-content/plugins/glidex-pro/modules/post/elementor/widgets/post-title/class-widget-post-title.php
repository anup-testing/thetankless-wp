...
class Elementor_Post_Title extends GlidexElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Title', 'glidex-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-title-wrapper '.$el_class.'">';
            $out .= glidex_get_template_part( 'post', 'templates/post-extra/title', '', $template_args );
		$out .= '</div>';
