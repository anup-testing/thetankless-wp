...
class Elementor_Post_Likes_Views extends GlidexElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Likes & Views', 'glidex-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-likes-views-wrapper '.$style.' '.$el_class.'">';
            $out .= glidex_get_template_part( 'post', 'templates/post-extra/likes_views', '', $template_args );
		$out .= '</div>';
