...
class Elementor_Post_Author extends GlidexElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Author', 'glidex-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-author-wrapper '.$style.' '.$el_class.'">';
            $out .= glidex_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/author', '', $template_args );
		$out .= '</div>';
