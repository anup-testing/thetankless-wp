...
class Elementor_Post_Comments extends GlidexElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Comments', 'glidex-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-comments-wrapper '.$style.' '.$el_class.'">';
            $out .= glidex_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/comment', '', $template_args );
		$out .= '</div>';
