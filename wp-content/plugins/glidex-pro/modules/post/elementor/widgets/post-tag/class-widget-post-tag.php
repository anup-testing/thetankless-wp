...
class Elementor_Post_Tags extends GlidexElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Tags', 'glidex-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-tags-wrapper '.$style.' '.$el_class.'">';
            $out .= glidex_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/tag', '', $template_args );
		$out .= '</div>';
