...
class Elementor_Post_Feature_Image extends GlidexElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Feature Image', 'glidex-pro');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'wdt_section_general', array(
            ...
            $this->add_control( 'enable_lightbox', array(
                ...
                'label'        => esc_html__('Enable Lightbox?', 'glidex-pro'),
                'label_on'     => esc_html__( 'Yes', 'glidex-pro' ),
                'label_off'    => esc_html__( 'No', 'glidex-pro' ),
                'return_value' => 'yes',
                'default'      => '',
				'description' => esc_html__('YES! to enable lightbox preview feature.', 'glidex-pro')
            ) );
    ...
    protected function render() {
		...
		$out .= '<div class="'.$el_class.'">';
            $out .= glidex_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/image', '', $template_args );
		$out .= '</div>';
