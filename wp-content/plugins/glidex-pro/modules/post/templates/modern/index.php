...
if( !class_exists( 'GlidexProPostModern' ) ) {
    class GlidexProPostModern {
        ...
        function add_post_styles_option( $options ) {
            $options['modern'] = esc_html__('Modern', 'glidex-pro');
            return $options;
        }
            ...
            if(is_singular('post')) {
                ...
                echo '<div class="post-modern">';
                    echo '<div class="post-single-image">';
                        glidex_template_part( 'post', 'templates/'.$post_style.'/parts/image', '', $template_args );
                    echo '</div>';
                    ?>
                            ...
                            if( !empty( $prev_post ) ):	?>
                                ...
                                <div class="post-prev-link"><?php
                                    ...
                                    <div class="nav-title-wrap">
                                        ...
                                        <p><a href="<?php echo get_permalink( $prev_post->ID ); ?>" title="<?php echo esc_attr($prev_post->post_title); ?>"><?php esc_html_e('Prev','glidex-pro'); ?></a></p>
                                        <h3><a href="<?php echo get_permalink( $prev_post->ID ); ?>" title="<?php echo esc_attr($prev_post->post_title); ?>"><?php
                                            if( get_the_title( $prev_post->ID ) == '') {
                                                echo esc_html__('Previous Post', 'glidex-pro');
                                            } else {
                                                glidex_html_output($prev_post->post_title);
                                            } ?></a>
                                        </h3>
                                    </div>
                                ...
                                <div class="post-prev-link no-post">
                                    ...
                                    <div class="nav-title-wrap">
                                        <span class="zmdi zmdi-long-arrow-left zmdi-hc-fw"></span>
                                        <h3><?php echo esc_html__('No previous story to show!', 'glidex-pro'); ?></h3>
                                    </div>
                                </div>
                                <?php
                            endif;
                            ...
                            if( !empty( $next_post ) ):	?>
                                <div class="post-next-link"><?php
                                    ...
                                    <div class="nav-title-wrap">
                                        ...
                                        <p><a href="<?php echo get_permalink( $next_post->ID ); ?>" title="<?php echo esc_attr($next_post->post_title); ?>"><?php esc_html_e('Next','glidex-pro'); ?></a></p>
                                        <h3><a href="<?php echo get_permalink( $next_post->ID ); ?>" title="<?php echo esc_attr($next_post->post_title); ?>"><?php
                                            if(get_the_title( $next_post->ID ) == '') {
                                                echo esc_html__('Next Post', 'glidex-pro');
                                            } else {
                                                glidex_html_output($next_post->post_title);
                                            } ?></a>
                                        </h3>
                                    </div>
                                ...
                                <div class="post-next-link no-post">
                                    ...
                                    <div class="nav-title-wrap">
                                        <span class="zmdi zmdi-long-arrow-right zmdi-hc-fw"></span>
                                        <h3><?php echo esc_html__('No next story to show!', 'glidex-pro'); ?></h3>
                                    </div>
                                </div>
                                <?php
                            endif;
