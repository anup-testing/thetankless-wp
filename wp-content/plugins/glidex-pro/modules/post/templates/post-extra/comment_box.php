<?php if ( ! defined( 'ABSPATH' ) ) { exit; } ?>
	...
	<?php else :
	    ...
	    <section class="commententries">
			<div id="disqus_thread"><?php if( $sitename == '' ) { echo '<div class="wdt-disqus-msg"><p class="error-msg">'.esc_html__('Put correct shortname from your Disqus account in Customizer settings.', 'glidex-pro').'</p></div>'; } ?></div>
			<script>
			/**
