...
if( !class_exists( 'GlidexProWidgetTitleSettings' ) ) {
    class GlidexProWidgetTitleSettings {
        ...
        function __construct() {
            $this->selector = apply_filters( 'glidex_widget_title_selector', array( '.secondary-sidebar .widgettitle' ) );
            $this->settings = glidex_customizer_settings('widget_title_typo');
            ...
            add_filter( 'glidex_widget_before_title_tag', array( $this, 'before_title' ));
            add_filter( 'glidex_widget_after_title_tag', array( $this, 'after_title' ));
        }
        ...
        function register( $wp_customize ){
             ...
             */
                $wp_customize->add_setting(
                    GLIDEX_CUSTOMISER_VAL . '[widget_title_tag]', array(
                        'type' => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    GLIDEX_CUSTOMISER_VAL . '[widget_title_tag]', array(
                        ...
                        'label'   => esc_html__( 'Title Tag', 'glidex-pro' ),
                        'choices' => array(
                            'h2'   => 'h2',
                            'h3'   => 'h3',
                            'h4'   => 'h4',
             ...
             */
            $wp_customize->add_setting(
                GLIDEX_CUSTOMISER_VAL . '[widget_title_color]', array(
                    'type'    => 'option',
                )
            );
            ...
            $wp_customize->add_control(
                new Glidex_Customize_Control_Color(
                    $wp_customize, GLIDEX_CUSTOMISER_VAL . '[widget_title_color]', array(
                        'section' => 'site-widgets-title-style-section',
             ...
             */
            $wp_customize->add_setting(
                GLIDEX_CUSTOMISER_VAL . '[widget_title_typo]', array(
                    'type'    => 'option',
                )
            );
            ...
            $wp_customize->add_control(
                new Glidex_Customize_Control_Typography(
                    $wp_customize, GLIDEX_CUSTOMISER_VAL . '[widget_title_typo]', array(
                        'type'    => 'wdt-typography',
                        'section' => 'site-widgets-title-style-section',
                        'label'   => esc_html__( 'Title Typography', 'glidex-pro'),
                    )
                )
            );
        ...
        function base_style( $style ) {
            $css   = '';
            $color = glidex_customizer_settings('widget_title_color');
        ...
        function before_title( $tag ) {
            $t = glidex_customizer_settings('widget_title_tag');
            if( !empty( $t ) ){
...
GlidexProWidgetTitleSettings::instance();