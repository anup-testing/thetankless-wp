...
class Glidex_Widget_Advance_Field extends WP_Widget {

    #1.constructor
	function __construct() {
		$widget_options = array(
			'classname'   => 'widget_advance_field',
			'description' => esc_html__('To add advance field', 'glidex-pro')
		);

        $theme_name =  defined('GLIDEX_THEME_NAME') ? GLIDEX_THEME_NAME : 'Glidex';
		parent::__construct( false, $theme_name . esc_html__(' Advanced Fields','glidex-pro'), $widget_options );
	}
	...
	?>
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('sub_title')); ?>">
        		<?php esc_html_e('Sub Title:','glidex-pro');?>
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('description')); ?>">
        		<?php esc_html_e('Description:','glidex-pro');?>
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('button_text')); ?>">
        		<?php esc_html_e('Button Text:','glidex-pro');?>
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('button_url')); ?>">
        		<?php esc_html_e('Button Link:','glidex-pro');?>
		...
		<p>        
			...
			<label for="<?php echo esc_attr($this->get_field_id('image_url')); ?>">
        		<?php esc_html_e('Image Link:','glidex-pro');?>
