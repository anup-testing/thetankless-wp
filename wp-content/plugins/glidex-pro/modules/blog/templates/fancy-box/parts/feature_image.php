        ...
        if( has_post_thumbnail( $post_ID ) ) :
            ...
            <div class="entry-thumb-meta-group">
                ...
                if(in_array('social', $archive_post_elements)) :
                    $path = glidex_get_template_part( 'blog', 'templates/post-extra/social', '', $template_args );
                    echo glidex_html_output($path);
                endif;
                if(in_array('category', $archive_post_elements)) :
                    $path = glidex_get_template_part( 'blog', 'templates/fancy-box/parts/category', '', $template_args );
                    $path = !empty( $path ) ? $path : glidex_get_template_part( 'blog', 'templates/post-extra/category', '', $template_args );
                    echo glidex_html_output($path);
                endif;
                ?>
            </div>
