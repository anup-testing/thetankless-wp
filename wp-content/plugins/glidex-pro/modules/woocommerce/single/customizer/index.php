...
if( !class_exists( 'Glidex_Pro_Customizer_Single' ) ) {

    class Glidex_Pro_Customizer_Single {
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_panel(
                new Glidex_Customize_Panel(
                    ...
                    array(
                        'title'    => esc_html__('Product Single Page', 'glidex-pro'),
                ...
                $wp_customize->add_section(
                    new Glidex_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Default Settings', 'glidex-pro'),
                ...
                $wp_customize->add_section(
                    new Glidex_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Upsell Settings', 'glidex-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 20,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new Glidex_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Related Settings', 'glidex-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 30,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new Glidex_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Sociable Share Settings', 'glidex-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 40,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new Glidex_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Sociable Follow Settings', 'glidex-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 50,
                        )
                    )
...
if( !function_exists('glidex_customizer_single') ) {
	function glidex_customizer_single() {
		return Glidex_Pro_Customizer_Single::instance();
	}
}

glidex_customizer_single();