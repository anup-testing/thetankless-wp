...
if( !class_exists( 'Glidex_Pro_Woo_single_Sidebar' ) ) {
    class Glidex_Pro_Woo_single_Sidebar {
        ...
        function frontend() {
            ...
            add_filter('glidex_active_sidebars', array( $this, 'active_sidebars' ), 30 );
        }
        ...
        function primary_classes( $primary_class ) {
            ...
            if( is_product() ) {
                ...
                $settings = get_post_meta( $post_id, '_glidex_layout_settings', true );
...
Glidex_Pro_Woo_single_Sidebar::instance();