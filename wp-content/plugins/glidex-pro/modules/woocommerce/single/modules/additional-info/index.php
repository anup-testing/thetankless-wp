...
if( !class_exists( 'Glidex_Shop_Single_Module_Additional_Info' ) ) {

    class Glidex_Shop_Single_Module_Additional_Info {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_DIR . '/woocommerce/single/modules/additional-info/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_URI . '/woocommerce/single/modules/additional-info/';
                } else {
...
if( !function_exists('glidex_shop_single_module_additional_info') ) {
	function glidex_shop_single_module_additional_info() {
        $reflection = new ReflectionClass('Glidex_Shop_Single_Module_Additional_Info');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Glidex_Shop_Single_Module_Custom_template' ) ) {
    Glidex_Shop_Single_Module_Additional_Info::instance();
}