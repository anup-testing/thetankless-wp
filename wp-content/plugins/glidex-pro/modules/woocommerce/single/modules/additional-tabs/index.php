...
if( !class_exists( 'Glidex_Shop_Single_Module_Additional_Tabs' ) ) {

    class Glidex_Shop_Single_Module_Additional_Tabs {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_DIR . '/woocommerce/single/modules/additional-tabs/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_URI . '/woocommerce/single/modules/additional-tabs/';
                } else {
...
if( !function_exists('glidex_shop_single_module_additional_tabs') ) {
	function glidex_shop_single_module_additional_tabs() {
        $reflection = new ReflectionClass('Glidex_Shop_Single_Module_Additional_Tabs');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Glidex_Shop_Single_Module_Additional_Tabs::instance();