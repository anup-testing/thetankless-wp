...
class Glidex_Shop_Widget_Product_Additional_Tabs_Exploded extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Single - Additional Tabs Exploded', 'glidex-pro' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section( 'product_additional_tabs_exploded_section', array(
			...
			$this->add_control( 'tab', array(
				...
				'default'     => 'description',
				'options'     => array(
					'custom_tab_1' => esc_html__( 'Custom Tab 1', 'glidex-pro' ),
					'custom_tab_2' => esc_html__( 'Custom Tab 2', 'glidex-pro' ),
					'custom_tab_3' => esc_html__( 'Custom Tab 3', 'glidex-pro' ),
					'custom_tab_4' => esc_html__( 'Custom Tab 4', 'glidex-pro' ),
					'custom_tab_5' => esc_html__( 'Custom Tab 5', 'glidex-pro' )
				),
			) );
	...
	protected function render() {
		...
		$output = glidex_shop_product_additional_tabs_exploded_render_html($settings);
