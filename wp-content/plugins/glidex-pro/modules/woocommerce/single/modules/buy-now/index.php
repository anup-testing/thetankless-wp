...
if( !class_exists( 'Glidex_Shop_Single_Module_Buy_Now' ) ) {

    class Glidex_Shop_Single_Module_Buy_Now {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_DIR . '/woocommerce/single/modules/buy-now/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_URI . '/woocommerce/single/modules/buy-now/';
                } else {
...
if( !function_exists('glidex_shop_single_module_buy_now') ) {
	function glidex_shop_single_module_buy_now() {
        $reflection = new ReflectionClass('Glidex_Shop_Single_Module_Buy_Now');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Glidex_Shop_Single_Module_Custom_template' ) ) {
    Glidex_Shop_Single_Module_Buy_Now::instance();
}