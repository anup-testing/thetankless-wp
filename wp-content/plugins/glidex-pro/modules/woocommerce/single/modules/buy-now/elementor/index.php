...
class Glidex_Shop_Elementor_Single_Buy_Now_Widgets {
	...
	function __construct() {
		...
		$this->glidex_shop_load_bn_modules();
	 ...
	 * Init
	 */
	function glidex_shop_load_bn_modules() {

		require glidex_shop_single_module_buy_now()->module_dir_path() . 'elementor/utils.php';
	...
	function glidex_shop_register_widget_styles( $suffix ) {
		...
		wp_register_style( 'wdt-shop-buy-now',
			glidex_shop_single_module_buy_now()->module_dir_url() . 'assets/css/style'.$suffix.'.css',
			array()
		);
	...
	function glidex_shop_register_widget_scripts( $suffix ) {
		...
		wp_register_script( 'wdt-shop-buy-now',
			glidex_shop_single_module_buy_now()->module_dir_url() . 'assets/js/scripts'.$suffix.'.js',
			array( 'jquery' ),
			false,
			true
		);
...
Glidex_Shop_Elementor_Single_Buy_Now_Widgets::instance();