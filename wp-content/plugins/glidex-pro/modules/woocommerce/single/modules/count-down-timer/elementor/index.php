...
class Glidex_Shop_Elementor_Single_Count_Down_Timer_Widgets {
	...
	function glidex_shop_load_cglidex_modules() {
		...
		require glidex_shop_single_module_count_down_timer()->module_dir_path() . 'elementor/utils.php';
	...
	function glidex_shop_register_widget_styles( $suffix ) {
		...
		wp_register_style( 'wdt-shop-coundown-timer',
			glidex_shop_single_module_count_down_timer()->module_dir_url() . 'assets/css/style'.$suffix.'.css',
			array()
		);
	...
	function glidex_shop_register_widget_scripts( $suffix ) {
		...
		wp_register_script( 'jquery-downcount',
			glidex_shop_single_module_count_down_timer()->module_dir_url() . 'assets/js/jquery.downcount'.$suffix.'.js',
			array( 'jquery' ),
			false,
			true
		);
		...
		wp_register_script( 'wdt-shop-coundown-timer',
			glidex_shop_single_module_count_down_timer()->module_dir_url() . 'assets/js/scripts'.$suffix.'.js',
			array( 'jquery' ),
			false,
			true
		);
...
Glidex_Shop_Elementor_Single_Count_Down_Timer_Widgets::instance();