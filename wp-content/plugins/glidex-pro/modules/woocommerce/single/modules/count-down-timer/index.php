...
if( !class_exists( 'Glidex_Shop_Single_Module_Count_Down_Timer' ) ) {

    class Glidex_Shop_Single_Module_Count_Down_Timer {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_DIR . '/woocommerce/single/modules/count-down-timer/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_URI . '/woocommerce/single/modules/count-down-timer/';
                } else {
...
if( !function_exists('glidex_shop_single_module_count_down_timer') ) {
	function glidex_shop_single_module_count_down_timer() {
        $reflection = new ReflectionClass('Glidex_Shop_Single_Module_Count_Down_Timer');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Glidex_Shop_Single_Module_Custom_template' ) ) {
    Glidex_Shop_Single_Module_Count_Down_Timer::instance();
}