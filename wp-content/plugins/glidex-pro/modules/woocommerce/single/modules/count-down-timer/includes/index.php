...
if ( ! function_exists( 'glidex_shop_products_sale_countdown_timer' ) ) {
	...
	function glidex_shop_products_sale_countdown_timer() {
		...
		echo '<div class="wdt-product-sale-countdown-holder">';
			echo '<div class="wdt-shop-downcount" data-date="'.esc_attr( date( 'm/d/Y H:i:s', $sale_date_end ) ).'" data-offset="'.esc_attr($gmt_offset).'">';
				echo '<div class="wdt-counter-wrapper">';
					...
					echo '</div>';
					echo '<h3 class="title">'.esc_html__('Day(s)', 'glidex-pro').'</h3>';
				echo '</div>';
				echo '<div class="wdt-counter-wrapper">';
					echo '<div class="counter-icon-wrapper">';
						echo '<div class="wdt-counter-number hours">00</div>';
					echo '</div>';
					echo '<h3 class="title">'.esc_html__('Hr(s)', 'glidex-pro').'</h3>';
				echo '</div>';
				echo '<div class="wdt-counter-wrapper">';
					echo '<div class="counter-icon-wrapper">';
						echo '<div class="wdt-counter-number minutes">00</div>';
					echo '</div>';
					echo '<h3 class="title">'.esc_html__('Min(s)', 'glidex-pro').'</h3>';
				echo '</div>';
				echo '<div class="wdt-counter-wrapper last">';
					echo '<div class="counter-icon-wrapper">';
						echo '<div class="wdt-counter-number seconds">00</div>';
					echo '</div>';
					echo '<h3 class="title">'.esc_html__('Sec(s)', 'glidex-pro').'</h3>';
				echo '</div>';
			echo '</div>';
		echo '</div>';
	...
	add_action( 'woocommerce_single_product_summary', 'glidex_shop_products_sale_countdown_timer', 15 );
