...
class Glidex_Shop_Widget_Product_Summary_Nav_bar extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Single - Summary Nav Bar', 'glidex-pro' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section( 'product_summary_nav_bar_section', array(
			...
			$this->add_control( 'items', array(
				...
				'default' => '',
				'options' => array(
					'breadcrumb'           => esc_html__( 'Summary Nav - Breadcrumb', 'glidex-pro' ),
					'navigation'           => esc_html__( 'Summary Nav - Navigation', 'glidex-pro' ),
				),
			) );
					...
					$output .= '<div class="wdt-product-summary-nav-bar '.$settings['class'].'">';
						...
						if(in_array('navigation', $items) || in_array('breadcrumbnavigation', $items)) {
							if( function_exists( 'glidex_shop_single_product_nav' ) ) {
								$navigation = glidex_shop_single_product_nav();
							}
						}
