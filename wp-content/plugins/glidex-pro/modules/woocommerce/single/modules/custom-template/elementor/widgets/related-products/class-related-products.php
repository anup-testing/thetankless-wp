...
class Glidex_Shop_Widget_Related_Products extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Single - Related Products', 'glidex-pro' );
	}
	...
	public function product_style_templates() {
		...
		$shop_product_templates['admin'] = esc_html__('Admin Option', 'glidex-pro');
		$shop_product_templates = array_merge ( $shop_product_templates, glidex_woo_listing_customizer_settings()->product_templates_list() );
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'product_featured_image_section', array(
			...
			$this->add_control( 'layout', array(
				'label'       => esc_html__( 'Layout', 'glidex-pro' ),
			...
			$this->add_control( 'columns', array(
				...
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'Choose column that you like to display upsell products.', 'glidex-pro' ),
			...
			$this->add_control( 'limit', array(
				'label'       => esc_html__( 'Limit', 'glidex-pro' ),
				'type'        => Controls_Manager::SELECT,
		...
		if($settings['product_id'] != '') {
			...
			$output .= '<div class="wdt-product-related-products ' .$carousel .$settings['class'].'" data-carousel_mousewheelcontrol="'.$settings['carousel_mousewheelcontrol'].'" data-carousel_bulletpagination="'.$settings['carousel_bulletpagination'].'" data-carousel_arrowpagination="'.$settings['carousel_arrowpagination'].'" data-carousel_spacebetween="'.$settings['carousel_spacebetween'].'"  data-carouselslidesperview="'.$settings['carousel_slidesperview'].'" data-carouselresponsive="'.esc_js($carousel_settings_value).'" data-layout="'.$settings['layout'].'">';
				...
				if($settings['product_style_template'] == 'admin') {
					$product_style_template = glidex_customizer_settings( 'wdt-single-product-related-style-template' );
				} else {
				...
				if($settings['layout']== "carousel")
				{
					...
					if($settings['carousel_arrowpagination'] == 'true') {
							...
							$output .= '<a href="#" class="wdt-related-product-image-gallery-arrow-prev">'.esc_html__('Prev', 'glidex-pro').'</a>';
							$output .= '<a href="#" class="wdt-related-product-image-gallery-arrow-next">'.esc_html__('Next', 'glidex-pro').'</a>';
							$output .= '</div>';
					}
