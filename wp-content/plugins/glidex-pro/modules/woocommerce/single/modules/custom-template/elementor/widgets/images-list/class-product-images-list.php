...
class Glidex_Shop_Widget_Product_Images_List extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Single - Images List', 'glidex-pro' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'product_images_list_section', array(
			...
			$this->add_control( 'product_id', array(
				...
				'description' => esc_html__('Provide product id for which you have to display woocommerce default product images gallery. No need to provide ID if it is used in Product single page.', 'glidex-pro'),
			) );

			$this->add_control( 'include_featured_image', array(
				'label'        => esc_html__( 'Include Feature Image', 'glidex-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'description'  => esc_html__('If you wish, you can include featured image in this listing.', 'glidex-pro'),
			...
			$this->add_control( 'include_gallery_images', array(
				'label'        => esc_html__( 'Include Gallery Images', 'glidex-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'description'  => esc_html__('If you wish, you can include gallery imagea in this listing.', 'glidex-pro'),
				'label_on'     => esc_html__( 'yes', 'glidex-pro' ),
				'label_off'    => esc_html__( 'no', 'glidex-pro' ),
				'default'      => 'true',
				'return_value' => 'true',
			...
			$this->add_control( 'columns', array(
				...
				'description' => esc_html__( 'Number columns to show images in.', 'glidex-pro' ),
				'options'     => array( 1 => 1, 2 => 2 ),
				'default'     => 2,
	        ) );

			$this->add_control( 'enable_grid_space', array(
				'label'        => esc_html__( 'Enable Grid Space', 'glidex-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'description'  => esc_html__('If you wish, you can enable grid space in this gallery.', 'glidex-pro'),
				'label_on'     => esc_html__( 'yes', 'glidex-pro' ),
				'label_off'    => esc_html__( 'no', 'glidex-pro' ),
				'default'      => '',
				'return_value' => 'true',
