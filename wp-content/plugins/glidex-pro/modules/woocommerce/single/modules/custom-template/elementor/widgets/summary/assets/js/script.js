( function( $ ) {
    ...
    var wdtShopProductSingleSummary = function($scope, $){
		...
		if($scope.hasClass('elementor-element-edit-mode')) {
			...
			var customCSS = jQuery('body', parent.document).find('style[id="glidex-woo-product-summary-inline-css"]').text();
			jQuery('body', parent.document).find('style[id="glidex-woo-product-summary-inline-css"]').remove();
            if(customCSS != '') {
