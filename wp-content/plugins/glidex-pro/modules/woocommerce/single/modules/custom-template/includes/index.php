...
if( ! function_exists( 'glidex_shop_woo_product_single_custom_template_option' ) ) {
	...
	function glidex_shop_woo_product_single_custom_template_option() {
...
if( ! function_exists( 'glidex_shop_woo_product_single_template' ) ) {

	function glidex_shop_woo_product_single_template( $single_template ) {

		if (is_singular( 'product' )) {

			$product_template = glidex_shop_woo_product_single_custom_template_option();

			if( $product_template == 'custom-template' ) {
				$single_template = glidex_shop_single_module_custom_template()->module_dir_path() . 'templates/custom-template.php';
			}else if ($product_template == 'admin-template') {
				$single_template = glidex_shop_single_module_custom_template()->module_dir_path() . 'templates/admin-option.php';
			}
	...
	add_filter('template_include', 'glidex_shop_woo_product_single_template', 100);
