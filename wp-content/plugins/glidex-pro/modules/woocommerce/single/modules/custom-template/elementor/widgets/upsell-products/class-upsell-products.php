...
class Glidex_Shop_Widget_Upsell_Products extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Single - Upsell Products', 'glidex-pro' );
	}
		...
		if($settings['product_id'] != '') {
			...
			$output .= '<div class="wdt-product-upsell-products '.$settings['class'].'">';
				...
				if($settings['product_style_template'] == 'admin') {
					$product_style_template = glidex_customizer_settings( 'wdt-single-product-upsell-style-template' );
				} else {
