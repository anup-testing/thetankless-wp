...
if(!function_exists('glidex_shop_product_tabs_exploded_html')) {
	function glidex_shop_product_tabs_exploded_html($attrs, $content = null) {
		...
		$attrs = shortcode_atts ( array (
			...
			'scroll_height' => '',
			'class'         => ''
		), $attrs, 'glidex_shop_product_tabs_exploded' );

		$out = glidex_shop_product_tabs_exploded_render_html($attrs);

		return $out;

	}
	add_shortcode( 'glidex_shop_product_tabs_exploded', 'glidex_shop_product_tabs_exploded_html' );
}


if(!function_exists('glidex_shop_product_tabs_exploded_render_html')) {
	function glidex_shop_product_tabs_exploded_render_html($settings) {
