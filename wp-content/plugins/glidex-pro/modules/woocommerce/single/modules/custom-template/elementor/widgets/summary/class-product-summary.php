...
class Glidex_Shop_Widget_Product_Summary extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Single - Summary', 'glidex-pro' );
	}

	public function get_style_depends() {
		$styles = apply_filters( 'glidex_shop_woo_single_summary_styles',  array ( 'wdt-shop-product-single-summary' ) );
		return $styles;
	}

	public function get_script_depends() {
		$scripts = apply_filters( 'glidex_shop_woo_single_summary_scripts',  array ( 'wdt-shop-product-single-summary' ) );
		return $scripts;
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'product_summary_section', array(
			...
			$repeater->add_control( 'summary_item', array(
				'label'       => esc_html__( 'Summary Item', 'glidex-pro' ),
				'type'        => Controls_Manager::SELECT,
				'default'     =>'title',
				'options'     => apply_filters( 'glidex_shop_woo_single_summary_options',
					array (
						'title'              => esc_html__('Summary Title', 'glidex-pro'),
						'rating'             => esc_html__('Summary Rating', 'glidex-pro'),
						'price'              => esc_html__('Summary Price', 'glidex-pro'),
						'stock'              => esc_html__('Summary Stock', 'glidex-pro'),
						'excerpt'            => esc_html__('Summary Excerpt', 'glidex-pro'),
						'addtocart'          => esc_html__('Summary Add To Cart', 'glidex-pro'),
						'buttons'            => esc_html__('Summary Buttons', 'glidex-pro'),
						'additional_feature' => esc_html__('Summary Additional Feature', 'glidex-pro'),
						'meta'               => esc_html__('Summary Meta', 'glidex-pro'),
						'meta_sku'           => esc_html__('Summary Meta SKU', 'glidex-pro'),
						'meta_category'      => esc_html__('Summary Meta Category', 'glidex-pro'),
						'meta_tag'           => esc_html__('Summary Meta Tag', 'glidex-pro'),
						'meta_brand'         => esc_html__('Summary Meta Brand', 'glidex-pro'),
						'additional_content' => esc_html__('Summary Additional Content', 'glidex-pro'),
						'separator1'         => esc_html__('Summary Separator 1', 'glidex-pro'),
						'separator2'         => esc_html__('Summary Separator 2', 'glidex-pro'),
						'clear1'         => esc_html__('Summary Clear 1', 'glidex-pro'),
						'clear2'         => esc_html__('Summary Clear 2', 'glidex-pro')
					)
				)
	        ) );
			...
			$this->add_control(
				'items',
				array (
					'label' => esc_html__( 'Items', 'glidex-pro' ),
					...
					'default' =>  array (
						...
						array (
							'summary_item' => 'additional_feature'
						)
					),
			...
			$repeater->add_control( 'button_item', array(
				'label'       => esc_html__( 'Button Item', 'glidex-pro' ),
				'type'        => Controls_Manager::SELECT,
				'default'     =>'',
				'options'     => apply_filters( 'glidex_shop_woo_single_summary_button_options',
					array (
						''          => esc_html__('None', 'glidex-pro'),
						'btaddtocart'  => esc_html__('Button Add to Cart', 'glidex-pro'),
						'wishlist'  => esc_html__('Button Wishlist', 'glidex-pro'),
						'compare'   => esc_html__('Button Compare', 'glidex-pro'),
						'buynow' 	=> esc_html__('Button Buy Now', 'glidex-pro')
					)
				)
	        ) );
			...
			$this->add_control(
				'button_items',
				array (
					'label' => esc_html__( 'Button Items', 'glidex-pro' ),
					'type' => Controls_Manager::REPEATER,
					'fields' => $repeater->get_controls(),
					'default' =>  array (),
			...
			$this->add_control( 'content', array(
				'label' => esc_html__( 'Additional Content', 'glidex-pro' ),
			...
			$this->add_control( 'alignment', array(
				...
				'default' => '',
				'options' => array(
					''            => esc_html__('Left', 'glidex-pro'),
					'aligncenter' => esc_html__('Center', 'glidex-pro'),
					'alignright'  => esc_html__('Right', 'glidex-pro'),
				),
				'description' => esc_html__( 'Choose alignment you would like to use for your product summary.', 'glidex-pro' ),
			) );

			$this->add_control( 'button_style', array(
				'label'   => esc_html__( 'Button Style', 'glidex-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'simple',
				'options' => array(
			...
			$this->add_control( 'button_radius', array(
				'label'   => esc_html__( 'Button Radius', 'glidex-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '',
				'options' => array(
            ...
            $this->add_control( 'button_apply_design_to_cart', array(
				'label'        => esc_html__( 'Button Apply Design to Cart', 'glidex-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'yes', 'glidex-pro' ),
				'label_off'    => esc_html__( 'no', 'glidex-pro' ),
				'default'      => '',
				'return_value' => 'true',
				'description'  => esc_html__( 'Use this option if you want to apply button design to Cart button also.', 'glidex-pro' ),
			) );

			$this->add_control( 'button_inline_alignment', array(
				'label'        => esc_html__( 'Button Inline Alignment', 'glidex-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'yes', 'glidex-pro' ),
				'label_off'    => esc_html__( 'no', 'glidex-pro' ),
				'default'      => '',
			...
			$this->add_control( 'button_hide_text', array(
				'label'        => esc_html__( 'Button Hide Text', 'glidex-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'yes', 'glidex-pro' ),
				'label_off'    => esc_html__( 'no', 'glidex-pro' ),
				'default'      => 'false',
			...
			$this->add_control( 'meta_inline_alignment', array(
				'label'        => esc_html__( 'Meta Inline Alignment', 'glidex-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'yes', 'glidex-pro' ),
				'label_off'    => esc_html__( 'no', 'glidex-pro' ),
				'default'      => '',
	...
	protected function render() {
		...
		if($settings['product_id'] != '' && $settings['items'] != '') {
			...
			if(!is_product()) {
				$output .= '<div class="woocommerce single-product">';
					...
					$output .= '<div class="wdt-product-summary summary entry-summary '.esc_attr($settings['class']).' '.esc_attr($settings['alignment']).'">';
						...
						// Countdown
						$stock = '';
						if(in_array('stock', $items)) {
							ob_start();
							if ( function_exists( 'glidex_shop_products_availabilty' ) ) {
								glidex_shop_products_availabilty();
							}
							$woocommerce_template_stock = ob_get_clean();
							$stock = $woocommerce_template_stock;
						}
						...
						if(in_array('countdown', $items)) {
							ob_start();
							if ( function_exists( 'glidex_shop_products_sale_countdown_timer' ) ) {
						...
						if(in_array('buttons', $items)) {
							...
							if(in_array('sizeguide', $button_items)) {
								ob_start();
								do_action( 'glidex_woo_loop_product_button_elements_sizeguide' );
							...
							if(in_array('buynow', $button_items)) {
								ob_start();
								do_action( 'glidex_woo_loop_product_button_elements_buynow' );
								$buynow = ob_get_clean();
								$buynow = $buynow;
							}
								...
								echo '<div class="wc_inline_buttons">';
									...
									foreach ($button_items as $key => $value) {
										if($value == 'btaddtocart') {
											echo '<div class="wcwl_btn_wrapper wc_btn_inline" data-tooltip="'.esc_attr__('Add to Cart', 'glidex-pro').'">';
												echo $$value;
											echo '</div>';
										} else {
											echo $$value;
						...
						if(in_array('meta_sku', $items)) {
							if ( wc_product_sku_enabled() && ( $product->get_sku() || $product->is_type( 'variable' ) ) ) {
								$meta_data_sku = ( $sku = $product->get_sku() ) ? $sku : esc_html__( 'N/A', 'glidex-pro' );
								$meta_sku = '<div class="product_meta_wrapper '.esc_attr($meta_inline_alignment_cls).'"><div class="product_meta"><span class="sku_wrapper"><strong>'.esc_html__( 'SKU:', 'glidex-pro' ).'</strong><span class="sku"> ' . $meta_data_sku . ' </span></span></div></div>';
							}
						}
						...
						if(in_array('meta_category', $items)) {
							$meta_category = '<div class="product_meta_wrapper '.esc_attr($meta_inline_alignment_cls).'"><div class="product_meta">'.wc_get_product_category_list( $product->get_id(), ', ', '<span class="posted_in"><strong>' . _n( 'Category:', 'Categories:', count( $product->get_category_ids() ), 'glidex-pro' ) . '</strong> ', '</span>' ).'</div></div>';
						}

						// Meta Tag
						$meta_tag = '';
						if(in_array('meta_tag', $items)) {
							$meta_tag = '<div class="product_meta_wrapper '.esc_attr($meta_inline_alignment_cls).'"><div class="product_meta">'.wc_get_product_tag_list( $product->get_id(), ', ', '<span class="tagged_as"><strong>' . _n( 'Tag:', 'Tags:', count( $product->get_tag_ids() ), 'glidex-pro' ) . '</strong> ', '</span>' ).'</div></div>';
						}
						...
						// Share / Follow
						$share_follow = '';
						if(in_array('share_follow', $items) && function_exists('glidex_shop_single_product_sociable_share_follow')) {
							$share_follow = glidex_shop_single_product_sociable_share_follow($settings['product_id'], $settings['share_follow_type'], $settings['social_icon_style'], $settings['social_icon_radius'], $settings['social_icon_inline_alignment']);
						}
						...
						// Additional Feature
						$additional_feature = '';
						if(in_array('additional_feature', $items)) {
							ob_start();
							if ( function_exists( 'glidex_shop_products_addtional_features' ) ) {
								glidex_shop_products_addtional_features($settings['product_id']);
							}
							$products_additional_infos = ob_get_clean();
							$additional_feature = $products_additional_infos;
						...
						if(in_array('additional_info', $items)) {
							ob_start();
							if ( function_exists( 'glidex_shop_products_additional_info' ) ) {
								glidex_shop_products_additional_info();
							}
						...
						if(in_array('additional_info_delivery_period', $items)) {
							ob_start();
							if ( function_exists( 'glidex_shop_products_ai_delivery_period' ) ) {
								glidex_shop_products_ai_delivery_period(true, $product_ai_delivery_period);
							}
						...
						if(in_array('additional_info_realtime_visitors', $items)) {
							ob_start();
							if ( function_exists( 'glidex_shop_products_ai_realtime_visitors' ) ) {
								glidex_shop_products_ai_realtime_visitors(true, $product_ai_visitors_min_value, $product_ai_visitors_max_value);
							}
						...
						if(in_array('additional_info_shipping_offer', $items)) {
							ob_start();
							if ( function_exists( 'glidex_shop_products_ai_shipping_offer' ) ) {
								glidex_shop_products_ai_shipping_offer(true);
							}
						...
						if(in_array('additional_info_weight', $items)) {
							$additional_info_weight = '<div class="product_additional_info_wrapper"><div class="product_additional_info"><span class="weight_wrapper"><strong>'.esc_html__('Weight:', 'glidex-pro').'</strong><span class="product_weight"> ' . esc_html( $product->get_weight() ) .  esc_html( get_option('woocommerce_weight_unit') ). ' </span></span></div></div>';
						}
						...
						if(in_array('additional_info_dimensions', $items)) {
							...
							if ( $product->has_dimensions() ) {
								$additional_info_dimensions = '<div class="product_additional_info_wrapper"><div class="product_additional_info"><span class="dimensions_wrapper"><strong>'.esc_html__('Dimensions:', 'glidex-pro').'</strong><span class="product_dimensions"> ' . esc_html( $dimensions ) . ' </span></span></div></div>';
							}
						}
						...
						if(in_array('additional_info_color', $items)) {
							ob_start();
							if ( function_exists( 'glidex_shop_products_ai_color' ) ) {
								glidex_shop_products_ai_color(true);
							}
						...
						if(in_array('additional_info_size', $items)) {
							ob_start();
							if ( function_exists( 'glidex_shop_products_ai_size' ) ) {
								glidex_shop_products_ai_size(true);
							}
			...
			wp_register_style( 'glidex-woo-product-summary', '', array (), GLIDEX_PRO_VERSION, 'all' );
			wp_enqueue_style( 'glidex-woo-product-summary' );
			...
			if( !empty($css) ) {
				wp_add_inline_style( 'glidex-woo-product-summary', $css );
			}


		} else {

			$output .= esc_html__('Please provide product id to display corresponding data!', 'glidex-pro');
