...
class Glidex_Shop_Elementor_Others_Size_Guide_Widgets {
	...
	function __construct() {
		...
		$this->glidex_shop_load_cglidex_modules();
	 ...
	 * Init
	 */
	function glidex_shop_load_cglidex_modules() {

		require glidex_shop_others_size_guide()->module_dir_path() . 'elementor/utils.php';
	...
	function glidex_shop_register_widget_styles( $suffix ) {
		...
		wp_register_style( 'swiper',
			glidex_shop_others_size_guide()->module_dir_url() . 'assets/css/swiper.min'.$suffix.'.css',
			array()
		);

		wp_register_style( 'wdt-shop-size-guide',
			glidex_shop_others_size_guide()->module_dir_url() . 'assets/css/style'.$suffix.'.css',
			array()
		);
	...
	function glidex_shop_register_widget_scripts( $suffix ) {
		...
		wp_register_script( 'jquery-swiper',
			glidex_shop_others_size_guide()->module_dir_url() . 'assets/js/swiper.min'.$suffix.'.js',
			array( 'jquery' ),
			false,
			true
		);
		...
		wp_register_script( 'wdt-shop-size-guide',
			glidex_shop_others_size_guide()->module_dir_url() . 'assets/js/scripts'.$suffix.'.js',
			array( 'jquery' ),
			false,
			true
		);
...
Glidex_Shop_Elementor_Others_Size_Guide_Widgets::instance();