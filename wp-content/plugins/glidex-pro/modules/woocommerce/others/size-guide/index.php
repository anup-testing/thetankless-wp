...
if( !class_exists( 'Glidex_Shop_Others_Size_Guide' ) ) {

    class Glidex_Shop_Others_Size_Guide {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_DIR . '/woocommerce/others/size-guide/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_URI . '/woocommerce/others/size-guide/';
                } else {
...
if( !function_exists('glidex_shop_others_size_guide') ) {
	function glidex_shop_others_size_guide() {
        $reflection = new ReflectionClass('Glidex_Shop_Others_Size_Guide');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Glidex_Shop_Others_Size_Guide::instance();