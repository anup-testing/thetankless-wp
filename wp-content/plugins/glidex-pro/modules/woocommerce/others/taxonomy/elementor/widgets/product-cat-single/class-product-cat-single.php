...
class Glidex_Shop_Widget_Product_Cat_Single extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Category - Single', 'glidex-pro' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'product_cat_single_section', array(
			...
			$this->add_control( 'cat_id', array(
				'label'   => esc_html__( 'Category Id', 'glidex-pro' ),
				'type'    => Controls_Manager::TEXT,
				'description' => esc_html__( 'Provide category id to show.', 'glidex-pro' ),
				'default' => ''
			) );
			...
			$this->add_control( 'image', array(
				...
				'label'     => esc_html__( 'Image', 'glidex-pro' ),
				'description' => esc_html__( 'Update if you like to use alternate image for this category.', 'glidex-pro' ),
			) );
