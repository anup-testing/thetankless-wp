...
if( !class_exists( 'Glidex_Shop_Others_Wishlist' ) ) {

    class Glidex_Shop_Others_Wishlist {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_DIR . '/woocommerce/others/wishlist/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_URI . '/woocommerce/others/wishlist/';
                } else {
...
if( !function_exists('glidex_shop_others_wishlist') ) {
	function glidex_shop_others_wishlist() {
        $reflection = new ReflectionClass('Glidex_Shop_Others_Wishlist');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Glidex_Shop_Others_Wishlist::instance();