...
if( !class_exists( 'Glidex_Shop_Others_Search' ) ) {

    class Glidex_Shop_Others_Search {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_DIR . '/woocommerce/others/search/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_URI . '/woocommerce/others/search/';
                } else {
         ...
         */
            function module_add_new_page_template( $templates ) {
                ...
                $templates = array_merge (
                    $templates,
                    array (
                        'tpl-product-search-listing.php' => esc_html__('Product Search Listing Template', 'glidex-pro')
                    )
                );
...
if( !function_exists('glidex_shop_others_search') ) {
	function glidex_shop_others_search() {
        $reflection = new ReflectionClass('Glidex_Shop_Others_Search');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Glidex_Shop_Others_Search::instance();