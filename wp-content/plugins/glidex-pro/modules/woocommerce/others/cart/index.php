...
if( !class_exists( 'Glidex_Shop_Others_Cart' ) ) {

    class Glidex_Shop_Others_Cart {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_DIR . '/woocommerce/others/cart/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_URI . '/woocommerce/others/cart/';
                } else {
...
if( !function_exists('glidex_shop_others_cart') ) {
	function glidex_shop_others_cart() {
        $reflection = new ReflectionClass('Glidex_Shop_Others_Cart');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Glidex_Shop_Others_Cart::instance();