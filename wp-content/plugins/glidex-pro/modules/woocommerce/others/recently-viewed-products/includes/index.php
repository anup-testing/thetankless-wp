...
if( !class_exists( 'Glidex_Shop_Others_Recently_Viewed_Products_Include' ) ) {

    class Glidex_Shop_Others_Recently_Viewed_Products_Include {
        ...
        function __construct() {
			...
			add_action( 'glidex_hook_bottom', array( $this, 'glidex_shop_recently_viewed_products_content' ) );
			add_action( 'wp', array( $this, 'glidex_shop_set_recently_viewed_products' ) );
         ...
         */
			function glidex_shop_recently_viewed_products_content() {
							...
							echo '<div class="wdt-shop-recently-viewed-products-holder">';
								...
								echo '<div class="wdt-shop-recently-viewed-products-wrapper">';
									...
									echo '<div class="wdt-shop-recently-viewed-products-title">';
										echo esc_html__('Recently Viewed', 'glidex-pro');
									echo '</div>';
												...
												echo '<div class="wdt-shop-recently-viewed-product swiper-slide">';
													...
													echo '<div class="wdt-shop-recently-viewed-product-info">';
														...
														if( !empty($add_to_cart) ) {
															...
															echo '<div class="wcct_btn_wrapper wc_btn_inline" data-tooltip="'.esc_attr__('Add To Cart', 'glidex-pro' ).'">'.glidex_html_output($add_to_cart).'</div>';
						...
						echo '<div class="wdt-shop-recently-viewed-products-holder">';
							...
							echo '<div class="wdt-shop-recently-viewed-products-wrapper">';
								...
								echo '<div class="wdt-shop-recently-viewed-products-container">';
									echo esc_html__('Sorry, there are no products.', 'glidex-pro');
								echo '</div>';
         ...
         */
			function glidex_shop_set_recently_viewed_products() {
				if(is_product()) {
...
if( !function_exists('glidex_shop_others_recently_viewed_products_include') ) {
	function glidex_shop_others_recently_viewed_products_include() {
        $reflection = new ReflectionClass('Glidex_Shop_Others_Recently_Viewed_Products_Include');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Glidex_Shop_Others_Recently_Viewed_Products_Include::instance();