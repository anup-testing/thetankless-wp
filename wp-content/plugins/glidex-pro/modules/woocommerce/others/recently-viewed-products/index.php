...
if( !class_exists( 'Glidex_Shop_Others_Recently_Viewed_Products' ) ) {

    class Glidex_Shop_Others_Recently_Viewed_Products {
        ...
        function __construct() {
            ...
            // Enqueue CSS
                add_action( 'glidex_before_woo_css', array ( $this, 'before_woo_css' ), 10 );

            // Enqueue JS
                add_action( 'glidex_before_woo_js', array ( $this, 'before_woo_js' ), 10 );
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_DIR . '/woocommerce/others/recently-viewed-products/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_URI . '/woocommerce/others/recently-viewed-products/';
                } else {
...
if( !function_exists('glidex_shop_others_recently_viewed_products') ) {
	function glidex_shop_others_recently_viewed_products() {
        $reflection = new ReflectionClass('Glidex_Shop_Others_Recently_Viewed_Products');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Glidex_Shop_Others_Recently_Viewed_Products::instance();