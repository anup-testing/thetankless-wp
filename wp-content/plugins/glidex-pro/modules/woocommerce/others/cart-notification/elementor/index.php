...
class Glidex_Shop_Elementor_Cart_Notification_Widgets {
	...
	function glidex_shop_register_widgets( $widgets_manager ) {
		...
		require glidex_shop_others_cart_notification()->module_dir_path() . 'elementor/widgets/menu-icon/class-widget-menu-icon.php';
		$widgets_manager->register( new Glidex_Shop_Widget_Menu_Icon() );
	...
	function glidex_shop_register_widget_styles( $suffix ) {
			...
			wp_register_style( 'wdt-shop-cart-widgets',
				glidex_shop_others_cart_notification()->module_dir_url() . 'assets/css/style'.$suffix.'.css',
				array()
			);

			wp_register_style( 'wdt-shop-menu-icon',
				glidex_shop_others_cart_notification()->module_dir_url() . 'elementor/widgets/menu-icon/assets/css/style'.$suffix.'.css',
				array()
			);
	...
	function glidex_shop_register_widget_scripts( $suffix ) {
			...
			wp_register_script( 'jquery-nicescroll',
				glidex_shop_others_cart_notification()->module_dir_url() . 'assets/js/jquery.nicescroll'.$suffix.'.js',
				array( 'jquery' ),
				false,
				true
			);
			...
			wp_register_script( 'wdt-shop-menu-icon',
				glidex_shop_others_cart_notification()->module_dir_url() . 'elementor/widgets/menu-icon/assets/js/script'.$suffix.'.js',
				array( 'jquery' ),
				false,
				true
			);
...
Glidex_Shop_Elementor_Cart_Notification_Widgets::instance();