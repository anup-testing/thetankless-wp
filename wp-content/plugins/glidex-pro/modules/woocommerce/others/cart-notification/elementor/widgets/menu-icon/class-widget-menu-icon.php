...
class Glidex_Shop_Widget_Menu_Icon extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Menu Icon', 'glidex-pro' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'cart_icon_section', array(
			'label' => esc_html__( 'Cart Icon', 'glidex-pro' ),
		) );

			$this->add_control( 'cart_action', array(
				'label'       => esc_html__( 'Cart Action', 'glidex-pro' ),
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'Choose how you want to display the cart content.', 'glidex-pro'),
				'default'     => '',
				'options'     => array(
		...
		$output .= '<div class="wdt-shop-menu-icon '.$settings['class'].'">';
			...
			if($settings['cart_action'] == 'notification_widget') {
				...
				$output .= '<div class="wdt-shop-menu-cart-content-wrapper">';
					$output .= '<div class="wdt-shop-menu-cart-content">'.esc_html__('No products added!', 'glidex-pro').'</div>';
				$output .= '</div>';
