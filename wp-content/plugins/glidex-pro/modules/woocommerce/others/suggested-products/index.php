...
if( !class_exists( 'Glidex_Shop_Others_Suggested_Products' ) ) {

    class Glidex_Shop_Others_Suggested_Products {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_DIR . '/woocommerce/others/suggested-products/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_URI . '/woocommerce/others/suggested-products/';
                } else {
...
if( !function_exists('glidex_shop_others_suggested_products') ) {
	function glidex_shop_others_suggested_products() {
        $reflection = new ReflectionClass('Glidex_Shop_Others_Suggested_Products');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Glidex_Shop_Others_Suggested_Products::instance();