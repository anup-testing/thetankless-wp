...
if( !class_exists( 'Glidex_Pro_Customizer_Others' ) ) {

    class Glidex_Pro_Customizer_Others {
             ...
             */
                $wp_customize->add_section(
                    new Glidex_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Others', 'glidex-pro'),
...
if( !function_exists('glidex_customizer_others') ) {
	function glidex_customizer_others() {
		return Glidex_Pro_Customizer_Others::instance();
	}
}

glidex_customizer_others();