...
if( !class_exists( 'Glidex_Shop_Others_Custom_Product_Type' ) ) {

    class Glidex_Shop_Others_Custom_Product_Type {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_DIR . '/woocommerce/others/custom-product-type/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( glidex_is_file_in_theme( __FILE__ ) ) {
                    return GLIDEX_MODULE_URI . '/woocommerce/others/custom-product-type/';
                } else {
...
if( !function_exists('glidex_shop_others_custom_product_type') ) {
	function glidex_shop_others_custom_product_type() {
        $reflection = new ReflectionClass('Glidex_Shop_Others_Custom_Product_Type');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Glidex_Shop_Others_Custom_Product_Type::instance();