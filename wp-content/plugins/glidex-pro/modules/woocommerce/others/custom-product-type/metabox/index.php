...
if( !class_exists( 'Glidex_Shop_Metabox_Single_Custom_Product_Type' ) ) {
    class Glidex_Shop_Metabox_Single_Custom_Product_Type {
        ...
        function product_options( $options ) {
			...
			if(is_array($custom_product_types) && !empty($custom_product_types)) {
				...
				$options[] = array(
					...
					'title'     => esc_html__('Custom Product Type','glidex-pro'),
					'post_type' => 'product',
					'context'   => 'side',
					'priority'  => 'low',
					'sections'  => array(
								...
								'fields' =>  array(
													...
													'type'       => 'radio',
													'title'      => esc_html__('Choose Product Type', 'glidex-pro'),
...
Glidex_Shop_Metabox_Single_Custom_Product_Type::instance();