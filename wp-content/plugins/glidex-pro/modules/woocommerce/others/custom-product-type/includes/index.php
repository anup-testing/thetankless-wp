...
if( ! function_exists( 'glidex_shop_woo_loop_product_custom_type' ) ) {

	function glidex_shop_woo_loop_product_custom_type($product_id) {
        ...
        if( $product_show_custom_type ) {
            ...
            if(isset($settings['custom-product-type']) && $settings['custom-product-type'] != '') {
                ...
                $woo_others_settings = glidex_woo_others()->woo_default_settings();
    ...
    add_action( 'glidex_woo_before_product_thumb_image', 'glidex_shop_woo_loop_product_custom_type', 10, 1 );
