...
if( !class_exists( 'Glidex_Pro_Woo_Sidebar' ) ) {
    class Glidex_Pro_Woo_Sidebar {
        ...
        function frontend() {
            add_filter('glidex_primary_classes', array( $this, 'primary_classes' ) );
            add_filter('glidex_secondary_classes', array( $this, 'secondary_classes' ) );
            add_filter('glidex_active_sidebars', array( $this, 'active_sidebars' ), 20 );
            add_filter('glidex_woo_loop_column_class', array( $this, 'woo_loop_column_class' ), 10, 2 );
        }

        function primary_classes( $primary_class ) {

            if( is_shop()  ) {
                $settings = get_post_meta( get_option('woocommerce_shop_page_id'), '_glidex_layout_settings', true );
...
Glidex_Pro_Woo_Sidebar::instance();