...
if( !class_exists( 'Glidex_Woo_Listing_Type_Custom' ) ) {

    class Glidex_Woo_Listing_Type_Custom {
        ...
        function __construct() {
            ...
            /* Initialize Type */
                ...
                $this->type_name = esc_html__('Custom', 'glidex-pro');
        ...
        */
            function set_type_options() {
                ...
                if( strpos($this->custom_template, 'predefined-template-') !== false ) {
                    ...
                    $field_key = str_replace('predefined-template-', 'glidex-woo-product-style-template-',  $this->custom_template);
                    ...
                    $custom_options = ( isset($dtcs_product_templates['glidex-woo-product-style-templates'][$field_key]) && !empty($dtcs_product_templates['glidex-woo-product-style-templates'][$field_key]) ) ? $dtcs_product_templates['glidex-woo-product-style-templates'][$field_key] : array ();
            ...
            function for_non_archive_listing() {
                ...
                /* Assets Load */
                    ...
                    // CSS
                        ...
                        wp_register_style( 'glidex-woo-non-archive', '', array (), GLIDEX_PRO_VERSION, 'all' );
...
if( !function_exists('glidex_woo_listing_type_custom') ) {
	function glidex_woo_listing_type_custom() {
		return Glidex_Woo_Listing_Type_Custom::instance();
	}
}

glidex_woo_listing_type_custom();