...
if( !function_exists('glidex_pro_get_template_plugin_part') ) {
    function glidex_pro_get_template_plugin_part( $file_path, $module, $template, $slug ) {

        $html             = '';
        $template_path    = GLIDEX_PRO_DIR_PATH . 'modules/' . esc_attr($module);
    ...
    add_filter( 'glidex_get_template_plugin_part', 'glidex_pro_get_template_plugin_part', 20, 4 );
}

if( !function_exists('glidex_pro_before_after_widget') ) {
    function glidex_pro_before_after_widget ( $content ) {
        $allowed_html = array(
            'aside' => array(
                'id'    => array(),
                'class' => array()
...
if( !function_exists('glidex_pro_widget_title') ) {
    function glidex_pro_widget_title( $content ) {
...
if( !function_exists('glidex_custom_post_type_elementor_support') ) {
    function glidex_custom_post_type_elementor_support() {
...
add_action('init', 'glidex_custom_post_type_elementor_support');
