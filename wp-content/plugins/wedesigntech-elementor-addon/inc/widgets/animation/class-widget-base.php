		...
		$elementor_object->start_controls_section( 'wdt_section_content', array(
            ...
            $repeater->add_control( 'content_type', array(
				...
				'options' => array(
					...
					'image_text' => esc_html__( 'Image & Text', 'wdt-elementor-addon' ),
					'icon_text' => esc_html__( 'Icon & Text', 'wdt-elementor-addon' ),
				)
			) );
            ...
            $repeater->add_control( 'image', array (
                ...
                'condition'   => array (
                    'content_type' => array('image','image_text'),
                )
            ) );
            ...
            $repeater->add_control( 'icon', array (
                ...
                'condition'   => array (
                    'content_type' =>array('icon_text','icon'),
                )
            ) );
            ...
            $repeater->add_control( 'text', array(
                ...
                'condition'   => array (
                    'content_type' =>array('text', 'image_text','icon_text'),
                )
            ) );
            ...
            $elementor_object->add_control( 'contents', array(
                ...
                'default' => array (
                    array (
                        'content_type' => array('text','image_text'),
				...
				if($directioncheck=="vertical")$directionis=$settings['wdt_vertical_direction'];
					...
					$output .= '<div class="wdt-animation-main-marqee '.esc_attr($directionis).'">';
						foreach( $settings['contents'] as $key => $item ) {
							if( $item['content_type'] == 'image' ) {
							...
							else if( $item['content_type'] == 'image_text' ) {

								$output .= '<div class="wdt-animation-item image-text">';
									$output .= '<div class="wdt-animation-item-image">';
										if(isset($item['image']['url']) && !empty($item['image']['url']) && !empty( $item['link']['url'] )) {
											$target = ( $item['link']['is_external'] == 'on' ) ? ' target="_blank" ' : '';
											$nofollow = ( $item['link']['nofollow'] == 'on' ) ? 'rel="nofollow" ' : '';
									...
									$output .= '</div>';
									$output .= '<div class="wdt-animation-item-text">';
										if( !empty( $item['link']['url'] ) && $item['text'] != '' ){
											$target = ( $item['link']['is_external'] == 'on' ) ? ' target="_blank" ' : '';
											$nofollow = ( $item['link']['nofollow'] == 'on' ) ? 'rel="nofollow" ' : '';
													$output .= '<a href="'.esc_url( $item['link']['url'] ).'"'. $target . $nofollow.'>';
								...
								$output .= '<div class="wdt-animation-item icon-text">';
									$output .= '<div class="wdt-animation-item-icon">';
