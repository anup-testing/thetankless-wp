...
class WeDesignTech_Widget_Elementor_Advanced_Toggle extends WeDesignTech_Elementor_Widget_Base {
...
wedesigntech_elementor_get_elementor_widgets_manager()->register( new WeDesignTech_Widget_Elementor_Advanced_Toggle() );