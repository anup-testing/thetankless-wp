...
class WeDesignTech_Widget_Elementor_Advanced_Video extends WeDesignTech_Elementor_Widget_Base {
	...
	function __construct( array $data = [], $args = null ) {
        ...
        $this->widget_base = wedesigntech_widget_base_advanced_video();
...
wedesigntech_elementor_get_elementor_widgets_manager()->register( new WeDesignTech_Widget_Elementor_Advanced_Video() );