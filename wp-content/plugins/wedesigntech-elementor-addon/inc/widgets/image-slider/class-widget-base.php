...
class WeDesignTech_Widget_Base_Image_Slider {
	...
	public function name() {
		return 'wdt-image-slider';
	}

	public function title() {
		return esc_html__( 'Image Slider', 'wdt-elementor-addon' );
	}
	...
	public function init_styles() {
		return array (
			'jquery-swiper' =>  WEDESIGNTECH_ELEMENTOR_ADDON_DIR_URL.'inc/widgets/image-slider/assets/css/swiper.min.css',
            $this->name() =>  WEDESIGNTECH_ELEMENTOR_ADDON_DIR_URL.'inc/widgets/image-slider/assets/css/style.css',	
		);
	}
	...
	public function init_scripts() {
		return array (
			'jquery-swiper' =>  WEDESIGNTECH_ELEMENTOR_ADDON_DIR_URL.'inc/widgets/image-slider/assets/js/swiper.min.js',
			$this->name() => WEDESIGNTECH_ELEMENTOR_ADDON_DIR_URL.'inc/widgets/image-slider/assets/js/script.js',
		);
	}
	...
	public function create_elementor_controls($elementor_object) {
		...
		$elementor_object->add_control(
			...
			array(
				...
				'toggle' => true,
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-info, {{WRAPPER}} .wdt-image-slider-icon-wrapper' => 'text-align: {{VALUE}};',
					'{{WRAPPER}} .wdt-image-slider-image, {{WRAPPER}} .wdt-image-slider-icon-wrapper' => 'justify-content: {{VALUE}};',
					'{{WRAPPER}} .wdt-image-slider-info p' => 'text-align: {{VALUE}};',
				),
			)
		...
		$elementor_object->add_control(
			...
			array(
				...
				'toggle' => true,
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-info' => 'align-self: {{VALUE}};',
				),
			)
		...
		$elementor_object->add_control(
			...
			array(
				...
				'toggle' => true,
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-info' => 'justify-self: {{VALUE}};',
				),
			)
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-container' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-container' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);	
		...
		$elementor_object->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-container, {{WRAPPER}} .wdt-image-slider-container h4, {{WRAPPER}} .wdt-image-slider-container a, {{WRAPPER}} .wdt-image-slider-container h6' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .wdt-image-slider-info',
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				'name' => 'border',
				'selector' => '{{WRAPPER}} .wdt-image-slider-container',
			)
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-container' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-container:hover, {{WRAPPER}} .wdt-image-slider-container:hover h4, {{WRAPPER}} .wdt-image-slider-container:hover a, {{WRAPPER}} .wdt-image-slider-container:hover h6' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				...
				'types' =>  array('classic', 'gradient', 'video' ),
				'selector' => '{{WRAPPER}} .wdt-image-slider-info:hover',
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				'name' => 'border_hover',
				'selector' => '{{WRAPPER}} .wdt-image-slider-container:hover',
			)
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-container:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .wdt-image-slider-title h4',
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-title h4' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-container h4' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-container:hover h4' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .wdt-image-slider-sub-title h6',
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-sub-title h6' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-container h6' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-container:hover h6' => 'color: {{VALUE}}',
				),
			)
		);
		$elementor_object->end_controls_tab();
		...
		$elementor_object->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .wdt-image-slider-content',
			)	
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);	
		...
		// 		'toggle' => true,
		// 		'selectors' => array(
		// 			'{{WRAPPER}} .wdt-image-slider-content' => 'text-align: {{VALUE}};',
		// 		),
		// 	)
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-content' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-content:hover' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				...
				'types' =>  array('classic', 'gradient', 'video' ),
				'selector' => '{{WRAPPER}} .wdt-image-slider-content:hover',
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-content:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-icon i' => 'font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-icon' => 'width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-icon' => 'height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);	
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-icon i' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				...
				'types' =>  array('classic', 'gradient', 'video' ),
				'selector' => '{{WRAPPER}} .wdt-image-slider-icon',
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-icon:hover i' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				...
				'types' =>  array('classic', 'gradient', 'video' ),
				'selector' => '{{WRAPPER}} .wdt-image-slider-icon:hover',
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-icon:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .wdt-image-slider-button-text span',
			)			
		);
		...
		$elementor_object->add_control(
			...
			array(
				...
				'toggle' => true,
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-button' => 'text-align: {{VALUE}};',
				),
			)
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-button a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-button a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);	
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-button a' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				...
				'types' =>  array('classic', 'gradient', 'video' ),
				'selector' => '{{WRAPPER}} .wdt-image-slider-button a',
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-button a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wdt-image-slider-button a:hover' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				...
				'types' =>  array('classic', 'gradient', 'video' ),
				'selector' => '{{WRAPPER}} .wdt-image-slider-button a:hover',
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-image-slider-button a:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-imagenail-carousel' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-imagenail-carousel' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);	
		...
		$elementor_object->add_group_control(
			...
			array(
				'name' => 'image_border',
				'selector' => '{{WRAPPER}} .wdt-imagenail-carousel',
			)		
		);
		...
		$elementor_object->add_responsive_control(
			...
			array (
				...
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-imagenail-carousel' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$elementor_object->add_group_control(
			...
			array(
				...
				'name' => 'image_image_border',
				'selector' => '{{WRAPPER}} .wdt-imagenail-carousel img',
			)
		);

		$elementor_object->add_responsive_control(
			'image-image-border-radius',
			array (
				'label' => esc_html__( 'Thumbnail Image Radius', 'wdt-elementor-addon' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => array ( 'px', 'em', '%' ),
				'selectors' => array (
					'{{WRAPPER}} .wdt-imagenail-carousel img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
	...
	public function get_image_carousel_attributes($settings) {
	...
	public function render_html($widget_object, $settings) {
		...
		$settings['module_class'] = 'carousel-slider-image-';
	
		$settings_attr = $this->get_image_carousel_attributes($settings);

		$output .= '<div class="wdt-image-carousel-holder" data-settings="'.esc_attr($settings_attr).'">';

			$output .= '<div class="swiper wdt-img-slider wdt-'.esc_attr($settings['module_class']).($settings['module_id']).'" data-id="'.($settings['module_id']).'" data-wrapper-class="wdt-'.esc_attr($settings['module_class']).($settings['module_id']).'">';
					...
					$output .= '<div class="swiper-wrapper">';
						foreach ( $settings['features_content'] as $index => $item ) {
							...
							if( $item['content_type'] == 'template' ) {
								...
								$output .='<div class="wdt-image-slider-container" id="wdt-image-slider-index-'.esc_attr($index).'">';

									$output .= '<div class="wdt-image-slider-image">';
					...
					$output .= '</div>';
			$output .= '</div>';		
				// $output .='<div class="wdt-image-pagination-group">';

			$output .= '<div class="swiper wdt-imagenail-carousel wdt-imagenail-carousel-'.($settings['module_id']).'" data-wrapper-image-class="wdt-imagenail-carousel-'.($settings['module_id']).'">';
				$output .= '<div class="swiper-wrapper">';
					foreach ( $settings['features_content'] as $index => $item ) {
						$prev_index = ($index - 1 >= 0) ? $index - 1 : count($settings['features_content']) - 1; 
						$next_index = ($index + 1 < count($settings['features_content'])) ? $index + 1 : 0; 
						$prev_item = $settings['features_content'][$prev_index];
						$next_item = $settings['features_content'][$next_index];
						$output .= '<div class="swiper-slide">';
							$output .= '<div class="wdt-image-slider-info">';
								$output .= '<div class="wdt-current-slide">';
									$output .= display_item($item); 
								$output .= '</div>';
								$output .= '<div class="wdt-prev-slide">';
									$output .= display_item($prev_item); 
								$output .= '</div>';
								$output .= '<div class="wdt-next-slide">';
									$output .= display_item($next_item); 
								$output .= '</div>';
							$output .= '</div>'; 
						$output .= '</div>'; 
					}
			...
			$output .= '<div class="wdt-imagecarousel-pagination-wrapper">';
				if ( $settings['arrows'] == 'yes' ) {
					$output .= '<div class="wdt-imagecarousel-arrow-pagination">';
						if(!empty( $settings['arrows_prev_icon']['value'])) {
							$output .= '<div class="wdt-arrow-image-pagination-prev wdt-arrow-image-pagination-prev-'.esc_attr($settings['module_id']).'">';
						...
						if(!empty($settings['arrows_next_icon']['value'])) {
							$output .= '<div class="wdt-arrow-image-pagination-next wdt-arrow-image-pagination-next-'.esc_attr($settings['module_id']).'">';
...
function display_item($item) {
    ...
    if (!empty($item['list_icon']['value'])) {
        $output .= '<div class="wdt-image-slider-icon-wrapper">';
            $output .= '<div class="wdt-image-slider-icon">';
    ...
    if (isset($item['list_sub_title']) && !empty($item['list_sub_title'])) {
        $output .= '<div class="wdt-image-slider-sub-title"><h6>' . $item['list_sub_title'] . '</h6></div>';
    }

    if (isset($item['list_title']) && !empty($item['list_title'])) {
        $output .= '<div class="wdt-image-slider-title"><h4>' . $item['list_title'] . '</h4></div>';
    }

    if (isset($item['list_content']) && !empty($item['list_content'])) {
        $output .= '<div class="wdt-image-slider-content">' . $item['list_content'] . '</div>';
    }
    ...
    if (!empty($item['button_link']['url']) && $item['button'] !== '') {
        ...
        $link_start = '<a href="' . esc_url($item['button_link']['url']) . '" class="wdt-button"' . $target . $nofollow . '>';
        $link_end = '</a>';
        $output .= '<div class="wdt-image-slider-button">' . $link_start . '<div class="wdt-image-slider-button-text"><span>' . $item['button'] . '</div></span>' . $link_end . '</div>';
    }

    return $output;
}
if( !function_exists( 'wedesigntech_widget_base_images_slider' ) ) {
    function wedesigntech_widget_base_images_slider() {
        return WeDesignTech_Widget_Base_Image_Slider::instance();
    }
}