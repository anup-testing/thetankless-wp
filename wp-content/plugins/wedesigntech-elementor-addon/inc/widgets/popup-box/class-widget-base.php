...
class WeDesignTech_Widget_Base_Popup_Box {
	...
	public function create_elementor_controls($elementor_object) {
		...
		$elementor_object->start_controls_section( 'wdt_section_settings', array(
			...
			$elementor_object->add_control( 'popup_class_name', array(
				'label'       => esc_html__( 'Popup Class', 'wdt-elementor-addon' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_html__( '.popup-calss', 'wdt-elementor-addon' ),
			));
	...
	public function render_html($widget_object, $settings) {
		...
		$pb_settings = array (
			...
			'popup_class'       => 'wdt-popup-box-window wdt-popup-box-window-'.esc_attr($module_id).' '.esc_attr($settings['animation_type']).' '.esc_attr($settings['popup_class_name']),
