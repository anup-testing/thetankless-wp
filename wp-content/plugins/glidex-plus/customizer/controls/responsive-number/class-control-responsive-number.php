...
class Glidex_Customize_Control_Responsive_Number extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'glidex-plus-responsive-number-control', GLIDEX_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.js', array( 'jquery', 'customize-base' ), GLIDEX_PLUS_VERSION, true );
		wp_enqueue_style( 'glidex-plus-responsive-number-control',  GLIDEX_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.css', null, GLIDEX_PLUS_VERSION );
	}
