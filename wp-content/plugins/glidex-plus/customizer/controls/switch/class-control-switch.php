...
class Glidex_Customize_Control_Switch extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'glidex-plus-switch-control',  GLIDEX_PLUS_DIR_URL.'customizer/controls/switch/switch.css', null, GLIDEX_PLUS_VERSION );
		wp_enqueue_script( 'glidex-plus-switch-control', GLIDEX_PLUS_DIR_URL.'customizer/controls/switch/switch.js', array( 'jquery', 'customize-base' ), GLIDEX_PLUS_VERSION, true );
	}
			...
			<div class="customize-control-content switch">
				...
				<label class="switch-label" for="switch_{{ data.id }}">
					<span class="switch-on">
						<# data.choices.on = data.choices.on || '<?php esc_html_e( 'On', 'glidex-plus' ); ?>' #>
						{{ data.choices.on }}
					</span>
					<span class="switch-off">
						<# data.choices.off = data.choices.off || '<?php esc_html_e( 'Off', 'glidex-plus' ); ?>' #>
						{{ data.choices.off }}
					</span>
				</label>
			</div>
