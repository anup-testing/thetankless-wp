...
class Glidex_Customize_Control_Description extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'glidex-plus-description-control',  GLIDEX_PLUS_DIR_URL.'customizer/controls/description/description.css', null, GLIDEX_PLUS_VERSION );
	}
