...
class Glidex_Customize_Control_Separator extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'glidex-plus-separator-control',  GLIDEX_PLUS_DIR_URL.'customizer/controls/separator/separator.css', null, GLIDEX_PLUS_VERSION );
	}
