...
class Glidex_Customize_Control_Responsive_Slider extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'glidex-plus-responsive-slider-control', GLIDEX_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.js', array( 'jquery', 'customize-base' ), GLIDEX_PLUS_VERSION, true );
		wp_enqueue_style( 'glidex-plus-responsive-slider-control',  GLIDEX_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.css', null, GLIDEX_PLUS_VERSION );
	}
