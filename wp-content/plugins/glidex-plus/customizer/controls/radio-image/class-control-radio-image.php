...
class Glidex_Customize_Control_Radio_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'glidex-plus-radio-image-control', GLIDEX_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.js', array( 'jquery', 'customize-base' ), GLIDEX_PLUS_VERSION, true );
		wp_enqueue_style( 'glidex-plus-radio-image-control',  GLIDEX_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.css', null, GLIDEX_PLUS_VERSION );
	}
