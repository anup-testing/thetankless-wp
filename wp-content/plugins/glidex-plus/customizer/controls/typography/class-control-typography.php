...
class Glidex_Customize_Control_Typography extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'glidex-plus-typography-control', GLIDEX_PLUS_DIR_URL.'customizer/controls/typography/typography.js', array( 'jquery', 'customize-base' ), GLIDEX_PLUS_VERSION, true );
		wp_enqueue_style( 'glidex-plus-typography-control',  GLIDEX_PLUS_DIR_URL.'customizer/controls/typography/typography.css', null, GLIDEX_PLUS_VERSION );

		$typo_localize = array(
			'inherit' => esc_html__( 'Inherit', 'glidex-plus' ),
			'100'     => esc_html__( 'Thin 100', 'glidex-plus' ),
			'200'     => esc_html__( 'Extra-Light 200', 'glidex-plus' ),
			'300'     => esc_html__( 'Light 300', 'glidex-plus' ),
			'400'     => esc_html__( 'Normal 400', 'glidex-plus' ),
			'500'     => esc_html__( 'Medium 500', 'glidex-plus' ),
			'600'     => esc_html__( 'Semi-Bold 600', 'glidex-plus' ),
			'700'     => esc_html__( 'Bold 700', 'glidex-plus' ),
			'800'     => esc_html__( 'Extra-Bold 800', 'glidex-plus' ),
			'900'     => esc_html__( 'Ultra-Bold 900', 'glidex-plus' ),
			'normal'  => esc_html__( 'Normal', 'glidex-plus' ),
			'normal'  => esc_html__( 'Normal', 'glidex-plus' ),
			'bold'    => esc_html__( 'Bold', 'glidex-plus' ),
			''        => esc_html__('Default', 'glidex-plus' ),
		);

		wp_localize_script( 'glidex-plus-typography-control', 'wdtPlusTypoObject', $typo_localize );
	}
	...
	public function get_custom_fonts() {
		$fonts = apply_filters( 'glidex_customizer_custom_fonts', array() );
		return $fonts;
	}
	...
	public function get_google_fonts() {
		...
		$google_fonts_file = GLIDEX_PLUS_DIR_PATH . 'customizer/controls/typography/google-fonts.json';
	...
	public function to_json() {
		...
		if ( ! is_array( $choices ) || empty( $choices ) ) {
			...
			$this->choices = array(
				'font_family'     => esc_html__( 'Font Family', 'glidex-plus'),
				'font_weight'     => esc_html__( 'Font Weight', 'glidex-plus'),
				'text_transform'  => esc_html__( 'Text Transform', 'glidex-plus'),
				'text_align'      => esc_html__( 'Text Align', 'glidex-plus'),
				'text_decoration' => esc_html__( 'Text Decoration', 'glidex-plus'),
				'font_style'      => esc_html__( 'Font Style', 'glidex-plus'),
				'font_size'       => esc_html__( 'Font Size', 'glidex-plus'),
				'line_height'     => esc_html__( 'Line Height', 'glidex-plus'),
				'letter_spacing'  => esc_html__( 'Letter Spacing', 'glidex-plus'),
			);
		}
		...
		<div class="wrapper">
			...
			<div class="full-width">
				...
				<select class="font-family">
					<option value=""><?php esc_html_e( 'Inherit', 'glidex-plus' );?></option>
					<optgroup label="<?php esc_html_e( 'Other System Fonts', 'glidex-plus' );?>">
					...
					<# if( _.isEqual( data.has_custom_fonts, {'item':'yes' } ) ) { #>
						<optgroup label="<?php esc_html_e( 'Custom Fonts', 'glidex-plus' );?>">
					...
					<optgroup label="<?php esc_html_e( 'Google', 'glidex-plus' );?>">
				...
				<# if( !_.isUndefined( data.choices['font_weight'] ) ) { #>
					<div class="one-half">
						...
						<select class="font-weight">
							<option value="inherit"><?php esc_html_e( 'Inherit', 'glidex-plus' );?></option>
						</select>
					</div>
				<# } #>
				...
				<# if( !_.isUndefined( data.choices['font_style'] ) ) { #>
					<div class="one-half">
						...
						<select class="font-style">
							...
							<option value="normal"<# if ( 'none' === data.value['font-style'] ) { #>selected<# } #>><?php esc_attr_e( 'Normal', 'glidex-plus' ); ?></option>
							<option value="italic"<# if ( 'italic' === data.value['font-style'] ) { #>selected<# } #>><?php esc_attr_e( 'Italic', 'glidex-plus' ); ?></option>
							<option value="oblique"<# if ( 'oblique' === data.value['font-style'] ) { #>selected<# } #>><?php esc_attr_e( 'Oblique', 'glidex-plus' ); ?></option>
							<option value="inherit"<# if ( 'inherit' === data.value['font-style'] ) { #>selected<# } #>><?php esc_attr_e( 'Inherit', 'glidex-plus' ); ?></option>
						</select>
					</div>
				<# } #>
			</div>
			...
			<# if( !_.isUndefined( data.choices['text_transform'] ) ) { #>
				<div class="full-width">
					...
					<select class="text-transform">
						...
						<option value="none"<# if ( 'none' === data.value['text-transform'] ) { #>selected<# } #>><?php esc_attr_e( 'None', 'glidex-plus' ); ?></option>
						<option value="capitalize"<# if ( 'capitalize' === data.value['text-transform'] ) { #>selected<# } #>><?php esc_attr_e( 'Capitalize', 'glidex-plus' ); ?></option>
						<option value="uppercase"<# if ( 'uppercase' === data.value['text-transform'] ) { #>selected<# } #>><?php esc_attr_e( 'Uppercase', 'glidex-plus' ); ?></option>
						<option value="lowercase"<# if ( 'lowercase' === data.value['text-transform'] ) { #>selected<# } #>><?php esc_attr_e( 'Lowercase', 'glidex-plus' ); ?></option>
						<option value="initial"<# if ( 'initial' === data.value['text-transform'] ) { #>selected<# } #>><?php esc_attr_e( 'Initial', 'glidex-plus' ); ?></option>
						<option value="inherit"<# if ( 'inherit' === data.value['text-transform'] ) { #>selected<# } #>><?php esc_attr_e( 'Inherit', 'glidex-plus' ); ?></option>
					</select>
				</div>
			<# } #>
				...
				<# if( !_.isUndefined( data.choices['text_align'] ) ) { #>
					<div class="one-half">
						...
						<select class="text-align">
							...
							<option value="unset"<# if ( 'unset' === data.value['text-align'] ) { #>selected<# } #>><?php esc_attr_e( 'Unset', 'glidex-plus' ); ?></option>
							<option value="left"<# if ( 'left' === data.value['text-align'] ) { #>selected<# } #>><?php esc_attr_e( 'Left', 'glidex-plus' ); ?></option>
							<option value="center"<# if ( 'center' === data.value['text-align'] ) { #>selected<# } #>><?php esc_attr_e( 'Center', 'glidex-plus' ); ?></option>
							<option value="right"<# if ( 'right' === data.value['text-align'] ) { #>selected<# } #>><?php esc_attr_e( 'Right', 'glidex-plus' ); ?></option>
							<option value="justify"<# if ( 'justify' === data.value['text-align'] ) { #>selected<# } #>><?php esc_attr_e( 'Justify', 'glidex-plus' ); ?></option>
							<option value="inherit"<# if ( 'inherit' === data.value['text-align'] ) { #>selected<# } #>><?php esc_attr_e( 'Inherit', 'glidex-plus' ); ?></option>
						</select>
					</div>
				<# } #>
				...
				<# if( !_.isUndefined( data.choices['text_decoration'] ) ) { #>
					<div class="one-half">
						...
						<select class="text-decoration">
							...
							<option value="none"<# if ( 'none' === data.value['text-decoration'] ) { #>selected<# } #>><?php esc_attr_e( 'None', 'glidex-plus' ); ?></option>
							<option value="underline"<# if ( 'underline' === data.value['text-decoration'] ) { #>selected<# } #>><?php esc_attr_e( 'Underline', 'glidex-plus' ); ?></option>
							<option value="overline"<# if ( 'overline' === data.value['text-decoration'] ) { #>selected<# } #>><?php esc_attr_e( 'Overline', 'glidex-plus' ); ?></option>
							<option value="line-through"<# if ( 'line-through' === data.value['text-decoration'] ) { #>selected<# } #>><?php esc_attr_e( 'Line Through', 'glidex-plus' ); ?></option>
							<option value="inherit"<# if ( 'inherit' === data.value['text-decoration'] ) { #>selected<# } #>><?php esc_attr_e( 'Inherit', 'glidex-plus' ); ?></option>
						</select>
					</div>
				<# } #>
			</div>
