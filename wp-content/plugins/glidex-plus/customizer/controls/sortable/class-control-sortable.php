...
class Glidex_Customize_Control_Sortable extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'glidex-plus-sortable-control', GLIDEX_PLUS_DIR_URL.'customizer/controls/sortable/sortable.js', array( 'jquery', 'customize-base' ), GLIDEX_PLUS_VERSION, true );
		wp_enqueue_style( 'glidex-plus-sortable-control',  GLIDEX_PLUS_DIR_URL.'customizer/controls/sortable/sortable.css', null, GLIDEX_PLUS_VERSION );
	}
