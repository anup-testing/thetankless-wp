...
class Glidex_Customize_Control_Responsive_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'glidex-plus-responsive-spacing-control', GLIDEX_PLUS_DIR_URL.'customizer/controls/responsive-spacing/responsive-spacing.js', array( 'jquery', 'customize-base' ), GLIDEX_PLUS_VERSION, true );
		wp_enqueue_style( 'glidex-plus-responsive-spacing-control',  GLIDEX_PLUS_DIR_URL.'customizer/controls/responsive-spacing/responsive-spacing.css', null, GLIDEX_PLUS_VERSION );
	}
