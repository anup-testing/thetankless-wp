...
class Glidex_Customize_Control_Fontawesome extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'glidex-plus-fontawesome-control', GLIDEX_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.js', array( 'jquery', 'customize-base' ), GLIDEX_PLUS_VERSION, true );
		wp_enqueue_style( 'glidex-plus-fontawesome-control',  GLIDEX_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.css', null, GLIDEX_PLUS_VERSION );

		wp_enqueue_style( 'glidex-plus-fontawesome',  GLIDEX_PLUS_DIR_URL . 'customizer/assets/css/fontawesome-all.css', array(),GLIDEX_PLUS_VERSION, 'all' );
	}
	...
	public function to_json() {
		...
		$this->json['reset'] = esc_html__( "Reset", "glidex-plus") .' '.esc_html( $this->label );
