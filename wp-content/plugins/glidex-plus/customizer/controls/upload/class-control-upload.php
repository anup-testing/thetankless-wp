...
class Glidex_Customize_Control_Upload extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'glidex-plus-upload-control',  GLIDEX_PLUS_DIR_URL.'customizer/controls/upload/upload.css', null, GLIDEX_PLUS_VERSION );
		wp_enqueue_script( 'glidex-plus-upload-control', GLIDEX_PLUS_DIR_URL.'customizer/controls/upload/upload.js', array( 'jquery', 'customize-base' ), GLIDEX_PLUS_VERSION, true );
	}
                ...
                <div class="upload-file">
                    <div class="attachment-file-view upload-file">
                        ...
                        <div class="actions">
                            ...
                            <button type="button" class="button upload-file-button"><?php esc_attr_e( 'Select File', 'glidex-plus' ); ?></button>
                        </div>
                    </div>
                </div>
			</div>
