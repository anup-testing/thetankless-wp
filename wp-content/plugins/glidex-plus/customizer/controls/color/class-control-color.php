...
class Glidex_Customize_Control_Color extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'glidex-plus-color-control', GLIDEX_PLUS_DIR_URL.'customizer/controls/color/color.js', array( 'jquery', 'customize-base' , 'glidex-plus-customizer-color-picker' ), GLIDEX_PLUS_VERSION, true );
		wp_enqueue_style( 'glidex-plus-color-control',  GLIDEX_PLUS_DIR_URL.'customizer/controls/color/color.css', null, GLIDEX_PLUS_VERSION );
	}
