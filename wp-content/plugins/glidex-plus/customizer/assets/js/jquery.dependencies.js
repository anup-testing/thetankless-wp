;(function ( $, window, document, undefined ) {
    'use strict';
    $.GLIDEXPLUSWPCUSTOMIZER = $.GLIDEXPLUSWPCUSTOMIZER || {};

	$.GLIDEXPLUSWPCUSTOMIZER.DEPENDENCY = function( el, param ) {
	...
	$.fn.GLIDEXPLUSWPCUSTOMIZER_DEPENDENCY = function ( param ) {
		return this.each(function () {
			new $.GLIDEXPLUSWPCUSTOMIZER.DEPENDENCY( this, param );
		});
	};

	$(document).ready( function() {
		$('.wp-customizer').GLIDEXPLUSWPCUSTOMIZER_DEPENDENCY();
	});
