(function($) {
    ...
    api.bind('pane-contents-reflowed', function() {
        ...
        api.section.each(function(section) {
            ...
            if ( 'glidex_extended_section' !== section.params.type || 'undefined' === typeof section.params.section ) {
        ...
        api.panel.each(function(panel) {
            ...
            if ( 'glidex_extend_panel' !== panel.params.type || 'undefined' === typeof panel.params.panel ) {
    ...
    wp.customize.Panel = wp.customize.Panel.extend({
        ...
        attachEvents: function() {
            ...
            if ( 'glidex_extend_panel' !== this.params.type || 'undefined' === typeof this.params.panel ) {
        ...
        isContextuallyActive: function() {
            ...
            if ( 'glidex_extend_panel' !== this.params.type ) {
    ...
    wp.customize.Section = wp.customize.Section.extend({
        ...
        attachEvents: function() {
            ...
            if ( 'glidex_extended_section' !== this.params.type || 'undefined' === typeof this.params.section ) {
        ...
        isContextuallyActive: function() {
            ...
            if ( 'glidex_extended_section' !== this.params.type ) {
