...
if( !class_exists( 'GlidexPlusH2Settings' ) ) {
    class GlidexPlusH2Settings {
        ...
        function __construct() {
            $this->selector = apply_filters( 'glidex_h2_selector', array( 'h2' ) );
            $this->settings = glidex_customizer_settings('h2_typo');

            add_filter( 'glidex_plus_customizer_default', array( $this, 'default' ) );
            add_action( 'customize_register', array( $this, 'register' ), 20);

            add_filter( 'glidex_h2_typo_customizer_update', array( $this, 'h2_typo_customizer_update' ) );
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new Glidex_Customize_Section(
                    ...
                    'site-h2-section',
                    array(
                        'title'    => esc_html__('H2 Typography', 'glidex-plus'),
             ...
             */
                $wp_customize->add_setting(
                    GLIDEX_CUSTOMISER_VAL . '[h2_typo]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new Glidex_Customize_Control_Typography(
                        $wp_customize, GLIDEX_CUSTOMISER_VAL . '[h2_typo]', array(
                            'type'    => 'wdt-typography',
                            'section' => 'site-h2-section',
                            'label'   => esc_html__( 'H2 Tag', 'glidex-plus'),
                        )
                    )
                );
             ...
             */
                $wp_customize->add_setting(
                    GLIDEX_CUSTOMISER_VAL . '[h2_color]', array(
                        'default' => '',
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        $wp_customize, GLIDEX_CUSTOMISER_VAL . '[h2_color]', array(
        ...
        function h2_typo_customizer_update( $defaults ) {
            $h2_typo = glidex_customizer_settings( 'h2_typo' );
            if( !empty( $h2_typo ) ) {
                return  $h2_typo;
            }
            return $defaults;
        ...
        function base_style( $style ) {
            $css   = '';
            $color = glidex_customizer_settings('h2_color');
