...
if( !class_exists( 'GlidexPlusH6Settings' ) ) {
    class GlidexPlusH6Settings {
        ...
        function __construct() {
            $this->selector = apply_filters( 'glidex_h6_selector', array( 'h6' ) );
            $this->settings = glidex_customizer_settings('h6_typo');

            add_filter( 'glidex_plus_customizer_default', array( $this, 'default' ) );
            add_action( 'customize_register', array( $this, 'register' ), 20);

            add_filter( 'glidex_h6_typo_customizer_update', array( $this, 'h6_typo_customizer_update' ) );
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new Glidex_Customize_Section(
                    ...
                    'site-h6-section',
                    array(
                        'title'    => esc_html__('H6 Typography', 'glidex-plus'),
             ...
             */
                $wp_customize->add_setting(
                    GLIDEX_CUSTOMISER_VAL . '[h6_typo]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new Glidex_Customize_Control_Typography(
                        $wp_customize, GLIDEX_CUSTOMISER_VAL . '[h6_typo]', array(
                            'type'    => 'wdt-typography',
                            'section' => 'site-h6-section',
                            'label'   => esc_html__( 'H6 Tag', 'glidex-plus'),
                        )
                    )
                );
             ...
             */
                $wp_customize->add_setting(
                    GLIDEX_CUSTOMISER_VAL . '[h6_color]', array(
                        'default' => '',
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        $wp_customize, GLIDEX_CUSTOMISER_VAL . '[h6_color]', array(
        ...
        function h6_typo_customizer_update( $defaults ) {
            $h6_typo = glidex_customizer_settings( 'h6_typo' );
            if( !empty( $h6_typo ) ) {
                return  $h6_typo;
            }
            return $defaults;
        ...
        function base_style( $style ) {
            $css   = '';
            $color = glidex_customizer_settings('h6_color');
