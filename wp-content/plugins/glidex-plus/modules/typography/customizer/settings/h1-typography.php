...
if( !class_exists( 'GlidexPlusH1Settings' ) ) {
    class GlidexPlusH1Settings {
        ...
        function __construct() {
            ...
            $this->selector = apply_filters( 'glidex_h1_selector', array( 'h1' ) );
            $this->settings = glidex_customizer_settings('h1_typo');

            add_filter( 'glidex_plus_customizer_default', array( $this, 'default' ) );
            add_action( 'customize_register', array( $this, 'register' ), 20);

            add_filter( 'glidex_h1_typo_customizer_update', array( $this, 'h1_typo_customizer_update' ) );
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new Glidex_Customize_Section(
                    ...
                    'site-h1-section',
                    array(
                        'title'    => esc_html__('H1 Typography', 'glidex-plus'),
             ...
             */
                $wp_customize->add_setting(
                    GLIDEX_CUSTOMISER_VAL . '[h1_typo]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new Glidex_Customize_Control_Typography(
                        $wp_customize, GLIDEX_CUSTOMISER_VAL . '[h1_typo]', array(
                            'type'    => 'wdt-typography',
                            'section' => 'site-h1-section',
                            'label'   => esc_html__( 'H1 Tag', 'glidex-plus')
                        )
                    )
                );
             ...
             */
                $wp_customize->add_setting(
                    GLIDEX_CUSTOMISER_VAL . '[h1_color]', array(
                        'default' => '',
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        $wp_customize, GLIDEX_CUSTOMISER_VAL . '[h1_color]', array(
        ...
        function h1_typo_customizer_update( $defaults ) {
            $h1_typo = glidex_customizer_settings( 'h1_typo' );
            if( !empty( $h1_typo ) ) {
                return  $h1_typo;
            }
            return $defaults;
        ...
        function base_style( $style ) {
            $css   = '';
            $color = glidex_customizer_settings('h1_color');
