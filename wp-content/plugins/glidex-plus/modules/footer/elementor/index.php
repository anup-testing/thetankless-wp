...
if( !class_exists( 'GlidexPlusFooterElementor' ) ) {
    class GlidexPlusFooterElementor {
        ...
        function frontend() {
            add_filter( 'glidex_print_footer_template', array( $this, 'register_footer_template' ), 10, 1 );
        }
		...
		function register_footer_template( $id ) {
                ...
                echo '<div class="'.esc_attr($class).'">';
                    echo '<div id="footer-'.esc_attr( $id ).'" class="wdt-footer-tpl footer-' .esc_attr( $id ). '">';
                        if( class_exists( '\Elementor\Core\Files\CSS\Post' ) ) {
                            ...
                            echo glidex_html_output($elementor_instance->frontend->get_builder_content_for_display( $id ));
                        } else {
                            $footer = get_post( $id );
            ...
            return apply_filters( 'glidex_plus_footer_content', $content );
		}
    }
}

GlidexPlusFooterElementor::instance();