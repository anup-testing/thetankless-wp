...
if( !class_exists( 'BlogPaginationInfiniteScroll' ) ) {
    class BlogPaginationInfiniteScroll {
        ...
        function enqueue_js_assets() {
        	wp_enqueue_script( 'post-infinite', GLIDEX_PLUS_DIR_URL . 'modules/blog/assets/js/post-infinite.js', array(), GLIDEX_PLUS_VERSION, true );
			wp_localize_script('post-infinite', 'glidex_urls', array(
