...
if( !class_exists( 'BlogPaginationLoadMore' ) ) {
    class BlogPaginationLoadMore {
        ...
        function enqueue_js_assets() {
        	wp_enqueue_script( 'post-loadmore', GLIDEX_PLUS_DIR_URL . 'modules/blog/assets/js/post-loadmore.js', array(), GLIDEX_PLUS_VERSION, true );
			wp_localize_script('post-loadmore', 'glidex_urls', array(
