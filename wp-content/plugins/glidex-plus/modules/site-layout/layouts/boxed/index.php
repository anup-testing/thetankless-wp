...
if( !class_exists( 'GlidexPlusSiteBoxedLayout' ) ) {
    class GlidexPlusSiteBoxedLayout {
        ...
        function backend() {
            add_filter( 'glidex_site_layouts', array( $this, 'add_boxed_layout_option' ) );
            add_filter( 'glidex_plus_customizer_default', array( $this, 'default' ) );
            add_action( 'glidex_site_layout_cutomizer_options', array( $this, 'register_site_layout' ) );
        }

        function frontend() {
            $enable = glidex_customizer_settings( 'customize_boxed_layout' );
        ...
        function add_boxed_layout_option( $options ) {
            $options['layout-boxed'] = esc_html__('Boxed', 'glidex-plus');
            return $options;
        }
        ...
        function register_site_layout( $wp_customize ) {
                ...
                $wp_customize->add_setting(
                    GLIDEX_CUSTOMISER_VAL . '[customize_boxed_layout]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new Glidex_Customize_Control_Switch(
                        $wp_customize, GLIDEX_CUSTOMISER_VAL . '[customize_boxed_layout]', array(
                            'type'        => 'wdt-switch',
                            'section'     => 'site-layout-main-section',
                            'label'       => esc_html__( 'Customize Boxed Layout?', 'glidex-plus' ),
                            'description' => esc_html__('YES! to customize boxed layout.', 'glidex-plus'),
                 ...
                 */
                $wp_customize->add_setting(
                    GLIDEX_CUSTOMISER_VAL . '[boxed_layout_background]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new Glidex_Customize_Control_Background(
                        $wp_customize, GLIDEX_CUSTOMISER_VAL . '[boxed_layout_background]', array(
                            'type'    => 'wdt-background',
                            'section' => 'site-layout-main-section',
        ...
        function base_style( $style ) {
            ...
            $css    = '';
            $bgoptions = glidex_customizer_settings('boxed_layout_background');
            ...
            if( !empty( $css ) ) {
                $style .= 'body.layout-boxed {'.glidex_html_output($css).'}'."\n";
            }
...
GlidexPlusSiteBoxedLayout::instance();