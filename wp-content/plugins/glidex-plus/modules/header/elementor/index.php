...
if( !class_exists( 'GlidexPlusHeaderElementor' ) ) {
    class GlidexPlusHeaderElementor {
        ...
        function frontend() {
            add_filter( 'glidex_print_header_template', array( $this, 'register_header_template' ), 10, 1 );
        }
		...
		function register_header_template( $id ) {
            ...
            return apply_filters( 'glidex_plus_header_content', $content );
		}
    }
}

GlidexPlusHeaderElementor::instance();