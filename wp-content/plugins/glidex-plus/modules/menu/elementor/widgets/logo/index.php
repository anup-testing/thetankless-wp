...
if( !class_exists( 'GlidexPlusLogoWidget' ) ) {
    class GlidexPlusLogoWidget {
        ...
        function register_widgets( $widgets_manager ) {
            require GLIDEX_PLUS_DIR_PATH. 'modules/menu/elementor/widgets/logo/class-widget-logo.php';
            $widgets_manager->register( new \Elementor_logo() );
        }

        function register_widget_styles() {
            wp_register_style( 'wdt-logo',
                GLIDEX_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/css/logo.css', array(), GLIDEX_PLUS_VERSION );
        }
