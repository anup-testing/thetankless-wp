...
if( !class_exists( 'GlidexPlusHeaderIconsWidget' ) ) {
    class GlidexPlusHeaderIconsWidget {
        ...
        function register_widgets( $widgets_manager ) {
            require GLIDEX_PLUS_DIR_PATH. 'modules/menu/elementor/widgets/header-icons/class-widget-header-icons.php';
            $widgets_manager->register( new \Elementor_Header_Icons() );
        }

        function register_widget_styles() {
            wp_register_style( 'wdt-header-icons',
                GLIDEX_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/css/header-icons.css', array(), GLIDEX_PLUS_VERSION );

            if( function_exists( 'is_woocommerce' ) ) {
                wp_register_style( 'wdt-header-carticons',
                    GLIDEX_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/css/header-carticon.css', array(), GLIDEX_PLUS_VERSION );
            }
        }

        function register_widget_scripts() {
            wp_register_script( 'jquery-nicescroll',
                GLIDEX_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/js/jquery.nicescroll.js', array(), GLIDEX_PLUS_VERSION, true );
            wp_register_script( 'wdt-header-icons',
                GLIDEX_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/js/header-icons.js', array(), GLIDEX_PLUS_VERSION, true );
        }
...
GlidexPlusHeaderIconsWidget::instance();
