...
class Elementor_Header_Icons extends GlidexElementorWidgetBase {
	...
	public function get_title() {
		return esc_html__( 'Header Icons', 'glidex-plus' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'header_icons_general_section', array(
			...
			$this->add_control( 'show_search_icon', array(
				'label'        => esc_html__( 'Show Search Icon', 'glidex-plus' ),
			...
			$this->add_control( 'search_icon_src', array(
				'label'        => esc_html__( 'Search Icon', 'glidex-plus' ),
			...
			$this->add_control( 'search_type', array(
				'label'       => esc_html__( 'Search Type', 'glidex-plus' ),
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'Choose type of search form to use.', 'glidex-plus'),
				'default'     => '',
				'options'     => array(
					''      => esc_html__( 'Default', 'glidex-plus'),
					'expand' => esc_html__( 'Expand', 'glidex-plus' ),
					'overlay' => esc_html__( 'Overlay', 'glidex-plus' )
				),
				'condition' => array( 'show_search_icon' => 'yes' )
			) );

			$this->add_control( 'show_userauthlink_icon', array(
				'label'        => esc_html__( 'Show Login / Logout Icon', 'glidex-plus' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'yes',
			) );
			...
			$this->add_control( 'userauthlink_icon_src', array(
				'label'        => esc_html__( 'User Logged Out Icon', 'glidex-plus' ),
				'type'         => Controls_Manager::ICONS,
				'default' => array(
					'value' => 'far fa-user',
					'library' => 'fa-regular',
			...
			$this->add_control( 'acc_redirect_page', array(
				'label'        => esc_html__( 'Account icon redirect url', 'glidex-plus' ),
				'type'         => Controls_Manager::TEXT,
				'description' => 'Redirect page URL / Slug name',
				'default' => '#',
                'condition' => array( 'show_userauthlink_icon' => 'yes' )
			) );		
            $this->add_control( 'userauthlink_loggedin_icon_src', array(
				'label'        => esc_html__( 'User Logged In Icon', 'glidex-plus' ),
				'type'         => Controls_Manager::ICONS,
				'default' => array(
					'value' => 'fas fa-user',
					'library' => 'fa-solid',
			...
			$this->add_control( 'show_cart_icon', array(
				'label'        => esc_html__( 'Show Cart Icon', 'glidex-plus' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'yes',
			) );
			...
			$this->add_control( 'cart_icon_src', array(
				'label'        => esc_html__( 'Cart Icon', 'glidex-plus' ),
				'type'         => Controls_Manager::ICONS,
				'default' => array(
			...
			$this->add_control( 'cart_action', array(
				'label'       => esc_html__( 'Cart Action', 'glidex-plus' ),
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'Choose how you want to display the cart content.', 'glidex-plus'),
				'default'     => '',
				'options'     => array(
					''                    => esc_html__( 'None', 'glidex-plus'),
					'notification_widget' => esc_html__( 'Notification Widget', 'glidex-plus' ),
					'sidebar_widget'      => esc_html__( 'Sidebar Widget', 'glidex-plus' ),
				),
				'condition' => array( 'show_cart_icon' => 'yes' )
	        ) );

			$this->add_control( 'show_wishlist_icon', array(
				'label'        => esc_html__( 'Show Wishlist Icon', 'glidex-plus' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'yes',
			) );
			...
			$this->add_control( 'wishlist_icon_src', array(
				'label'        => esc_html__( 'Wishlist Icon', 'glidex-plus' ),
				'type'         => Controls_Manager::ICONS,
				'default' => array(
					'value' => 'far fa-heart',
					'library' => 'fa-regular',
        ...
        $this->start_controls_section( 'wdt_section_color', array(
			...
			$this->add_control( 'icons_color', array(
				'label'     => esc_html__( 'Icons Color', 'glidex-plus' ),
			...
			$this->add_control( 'icons_hover_color', array(
				'label'     => esc_html__( 'Icons Hover Color', 'glidex-plus' ),
				'type'      => Controls_Manager::COLOR,
				'default' 	=> '',
					...
					$output .= '<div class="wdt-header-icons-list-item user-authlink-item">';
						...
						if (is_user_logged_in()) {
                            ...
                            $output .= '<div class="wdt-user-authlink-menu-icon">';
                                ...
                                $output .= '<span class="icotype-label">'.esc_html__('Log Out', 'glidex-plus').'</span></span></a>';
                            $output .= '</div>';
							...
							$output .= '<div class="wdt-user-authlink-menu-icon">';
								$output .= '<a href="'.$settings['acc_redirect_page'].'"><span>';
									...
									$output .= '<span class="icotype-label">'.esc_html__('Log In', 'glidex-plus').'</span></span></a>';
							$output .= '</div>';
						}
						...
						$output .= '<div class="wdt-shop-menu-icon">';
							...
							if($settings['cart_action'] == 'notification_widget') {
								...
								$output .= '<div class="wdt-shop-menu-cart-content-wrapper">';
									$output .= '<div class="wdt-shop-menu-cart-content">'.esc_html__('No products added!', 'glidex-plus').'</div>';
								$output .= '</div>';
							...
							$output .= '<div class="wdt-wishlist-menu-icon">';
								$output .= '<a href="'.get_permalink($wishlist_page_id).'">';
									$output .= '<span>';
										...
										$output .= '<span class="icotype-label">'.esc_html__('Wishlist', 'glidex-plus').'</span>';
