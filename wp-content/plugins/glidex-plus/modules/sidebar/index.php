...
if( !class_exists( 'GlidexPlusSidebar' ) ) {
    class GlidexPlusSidebar {
        ...
        function load_modules() {
            include_once GLIDEX_PLUS_DIR_PATH.'modules/sidebar/customizer/index.php';
        }

        function frontend() {
            add_filter('glidex_primary_classes', array( $this, 'primary_classes' ), 10 );
            add_filter('glidex_secondary_classes', array( $this, 'secondary_classes' ), 10 );
        }
